...
The Users lifecycle commands require global USERS_MANAGE; the row Group editor requires global SYSTEM_ADMIN and replaces ordinary memberships while preserving system memberships and retained manager flags. Capability-specific Group and Source behavior remains in the IAM authority and [Connector](connector.md) contracts rather than being duplicated here.
