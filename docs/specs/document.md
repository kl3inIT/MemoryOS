...
Document owns normalized durable knowledge independently of provider implementation. A Document is Organization-scoped and either ELIGIBLE or INELIGIBLE. DocumentVersion is immutable and records bounded normalized text, safe title, detected media type, source-content SHA-256, and metadata.
