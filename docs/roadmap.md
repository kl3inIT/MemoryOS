...
| [MEM-29–33](https://linear.app/memory-os/issue/MEM-29/use-client-side-routing-for-internal-application-navigation) | Frontend lifecycle hardening across client navigation, persistent authenticated layouts, browser-session query convergence, single-flight invitation creation, and CSP-compatible font assets | [Design](increments/active/mem-29-33-frontend-lifecycle-hardening/design.md) · [Plan](increments/active/mem-29-33-frontend-lifecycle-hardening/plan.md) · [Verification](increments/active/mem-29-33-frontend-lifecycle-hardening/verification.md) |
