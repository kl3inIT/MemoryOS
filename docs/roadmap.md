...
| Increment | Outcome | Evidence |
| --- | --- | --- |
| [MEM-27](https://linear.app/memory-os/issue/MEM-27/mature-frontend-interaction-tokens-and-component-states) | Enforce Onyx/Opal-informed action prominence, interaction states, and shared control sizes across the production frontend | [Design](increments/active/mem-27-frontend-interaction-contracts/design.md) · [Plan](increments/active/mem-27-frontend-interaction-contracts/plan.md) · [Verification](increments/active/mem-27-frontend-interaction-contracts/verification.md) |
