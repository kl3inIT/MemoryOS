...
| A closed dictation session adds its recorded seconds once | `core/src/test/java/io/memoryos/voice/VoiceTranscriptionServiceTest.java` — `aClosedSessionAddsItsRecordedSecondsToAiUsageOnce` |
