...
| Native-sized raw storage does not widen binary/browser admission or permit native objects in browser uploads | `ObjectWriteLifecycleIntegrationTest.nativeStorageDoesNotWidenBinaryOrBrowserAdmission` |
