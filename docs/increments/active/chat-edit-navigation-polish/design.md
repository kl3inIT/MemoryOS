...
- **Dictation, draft restore, quote and image preview** follow in separate commits after review of this first element; stopped runs ("Đã dừng") and the empty state (heading plus starters) already exist and receive no new UI.
