...
**Phạm vi quyền không đổi.** Onyx có principal ACL trong index; MemoryOS hiện dùng PUBLIC FILE eligibility sau retrieval. Việc batch lookup sẽ áp dụng đúng chính sách hiện có theo tập IDs, không lấy metadata filter làm ACL và không bỏ current-generation checks. Hoàn thiện source ACL trước top-k vẫn là integration boundary đã ghi ở phần phạm vi; chỉ phục vụ source thật được cấp quyền. Với runtime hiện chỉ tìm được FILE, source classifier được bỏ qua theo chính điều kiện dưới hai loại nguồn của Onyx; luồng chuyển scope được kiểm bằng fixtures có các source được cấp quyền, không quảng cáo provider chưa nghiệm thu.
...
- [Hai rewrite đồng thời](https://github.com/onyx-dot-app/onyx/blob/40eb240df370688ed6eeedc1272116e7829554ac/backend/onyx/tools/tool_implementations/search/search_tool.py#L603), [search fan-out và gộp trước selection](https://github.com/onyx-dot-app/onyx/blob/40eb240df370688ed6eeedc1272116e7829554ac/backend/onyx/tools/tool_implementations/search/search_tool.py#L973), [mở rộng đồng thời](https://github.com/onyx-dot-app/onyx/blob/40eb240df370688ed6eeedc1272116e7829554ac/backend/onyx/tools/tool_implementations/search/search_tool.py#L1166).
- [Quy tắc gộp chunk liền nhau](https://github.com/onyx-dot-app/onyx/blob/40eb240df370688ed6eeedc1272116e7829554ac/backend/onyx/context/search/pipeline.py#L145), [rewrite yêu cầu OFF](https://github.com/onyx-dot-app/onyx/blob/40eb240df370688ed6eeedc1272116e7829554ac/backend/onyx/secondary_llm_flows/query_expansion.py#L148), [classification và selection yêu cầu OFF](https://github.com/onyx-dot-app/onyx/blob/40eb240df370688ed6eeedc1272116e7829554ac/backend/onyx/secondary_llm_flows/document_filter.py#L138).
- [Dedup cộng weights](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/tools/tool_implementations/search/search_tool.py#L171), [RRF tie-break](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/tools/tool_implementations/search/search_utils.py#L31), [reuse expansion khi đổi scope](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/tools/tool_implementations/search/search_tool.py#L829).
- [Cửa sổ ba chunk](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/secondary_llm_flows/document_filter.py#L26), [metadata selection](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/secondary_llm_flows/document_filter.py#L222), [source detection và bỏ call khi ít nguồn](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/secondary_llm_flows/source_filter.py#L55), [time filter precedence](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/secondary_llm_flows/time_filter.py#L30).
- [Prefetch trước fan-out](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/tools/tool_implementations/search/search_tool.py#L679), [query progress](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/tools/tool_implementations/search/search_tool.py#L963), [selected documents trước expansion](https://github.com/onyx-dot-app/onyx/blob/bd89d269bbae9c3931faaa2076f5ccb6917cbd2a/backend/onyx/tools/tool_implementations/search/search_tool.py#L1125).
...
| Sources | Keep the compact action next to Copy, replace inline collapsible cards with the Onyx-style right panel. Panel owns only selected message/source; native runtime continues owning message state. |
