...
Ngày kiểm: 2026-09-09. Phạm vi được duyệt: kiểm thêm một vòng trước execution production, giữ JDBC Phase 2.1 và baseline Onyx. Đây là verification framework cô lập, không phải Chat đã giao cho người dùng.
...
Audit được yêu cầu sau entrypoint probe để chuẩn hóa reuse theo toàn bộ parity, không chỉ Phase 2.1–2.2. Đã đọc lại native Usage/PricingModel/LlmInvocation/Budget, streaming operations/loop, Conversation/Factory/ChatSession/AgentProcessChatbot và Onyx llm_loop, llm/cost, token_limit. Quyết định canonical nằm ở [design](design.md#end-to-end-framework-integration); kế hoạch không tăng số phase.
