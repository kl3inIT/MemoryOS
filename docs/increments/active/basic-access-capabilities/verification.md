...
- Full integrated backend/browser reruns and remote checks are recorded below once complete. Merge, deployment and divergent-database reconciliation remain outside this repair.
