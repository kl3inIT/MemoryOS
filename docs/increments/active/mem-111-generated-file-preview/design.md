...
2. **Variants, in the Onyx order.**
   ...
   - docx: `docx-preview` plus DOMPurify with the Onyx allowlist, reflowed to the panel width (`ignoreWidth`) because the panel is narrower than a page; `.doc` shows the Onyx legacy message.
