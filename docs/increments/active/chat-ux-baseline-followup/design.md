...
Accepted 2026-09-12: correct the audited composer, file picker, editing, Project files, header and Vietnamese copy; add automatic conversation naming and file citation positioning. Reference: Onyx checkout `40eb240df370688ed6eeedc1272116e7829554ac`, FilePickerPopover, ProjectContextPanel, HumanMessage and chat_session_naming.
