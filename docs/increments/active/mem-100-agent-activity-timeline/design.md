...
Its migration adds `chat_message.activity jsonb NOT NULL DEFAULT '{}'` under the next free version (V54–V60 are taken), ASSISTANT-only, with CHECK constraints in the style of V34/V42:
