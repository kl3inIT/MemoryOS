...
- [ ] Migrations with their writers: `chat_message.is_clarification` and plan text (done 2026-09-15: V66 with the terminal finish writer and history), `chat_tool_call` tree with bounds (research persistence step).
