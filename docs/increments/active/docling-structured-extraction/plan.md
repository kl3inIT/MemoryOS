...
- [x] Define canonical block/table/provenance/manifest schema and processing profile for FILE and the later Google-native adapters.
- [x] Add migration for artifact references and processing identity; preserve existing completed versions and bounded text compatibility. Real PostgreSQL lifecycle tests pass.
...
- Branch: `mem-61-docling-extraction`, based on `0279988`. No commit, merge or staging deployment recorded for this increment.
