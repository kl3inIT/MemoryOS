...
**RAGFlow** đã được increment [Tasco scanned-PDF OCR](../tasco-scanned-pdf-ocr/design.md) nghiên cứu và loại: từ điển OCR DeepDoc thiếu ký tự tiếng Việt cơ bản, adapter Docling của họ làm mất nguồn gốc bảng.
