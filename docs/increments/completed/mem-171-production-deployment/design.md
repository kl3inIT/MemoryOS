...
**Đã chốt 2026-09-22 — máy chủ không dùng Infisical.** Secret trên máy chủ là file sinh tại chỗ; Infisical chỉ còn phục vụ laptop lập trình viên. Xem [increment riêng](../../active/server-secrets-as-files/design.md). Production vì vậy **không cần** environment `prod` hay machine identity nào, và không bao giờ có file bootstrap.
