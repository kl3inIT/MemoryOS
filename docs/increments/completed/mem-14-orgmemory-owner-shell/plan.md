# MEM-14 plan: OrgMemory and reference implementation-aligned application shell
...
3. Implement reference implementation-style fold behavior: 15rem/4rem widths and logo-to-expand hover/focus swap.
...
8. Move the interface to Hanken Grotesk and the reference implementation typography scale.
