...
1. V100: `archived_at`, `branched_from_*`, partial indexes for the sidebar and the archive. ✔
...
7. V101: `chat_session.temporary`, `chat_user_file.temporary_session_id`, `chat_settings.chat_retention_days`, and the indexes each sweep reads. ✔
...
12. V102 `chat_export` plus the repository, with the partial unique index that admits one export per person. ✔
