...
> **2026-09-25 — moved again.** The adapter now lives in `io.memoryos.ai.openai`, internal to the `ai` module, without the `openai` named interface ([ADR 0015](../../../decisions/0015-capability-module-map.md#step-2-what-ai-and-voice-hold)).
