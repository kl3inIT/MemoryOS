...
| Chat deployment default | Một default model configuration trong Tenant cho Chat. Chỉ tạo các flow khác khi có consumer; không copy toàn bộ LLMModelFlow của reference implementation |
...
- Scope full design thêm công thiết kế và tests nền ngay trong MEM-11; đổi lại MEM-77 không tự quyết schema/API/ownership/entrypoint. Kiến trúc này không được tuyên bố tốt hơn reference implementation nói chung; các khác biệt có consumer và tradeoff ở trên.
