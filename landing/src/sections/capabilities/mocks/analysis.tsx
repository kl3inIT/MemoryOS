...
const request = "Spend by team last quarter, as a chart";
  ...
  return (
    <div className="flex h-full flex-col justify-center gap-3 p-5 sm:p-6">
      <div className={cn(illustrationCard, "px-3 py-2")}>
        <p className={illustrationLabel}>Ask</p>
        <p {...enter("type", 0)} className="mt-1 truncate font-main-ui-body text-content-primary">
          {request}
        </p>
      </div>
      <div
