...
- [MEM-102 — Task models and provider data boundary](docs/increments/active/mem-102-helper-model/design.md) owns per-task Tenant models (conversation naming first) and the recorded Internal/External provider boundary; enforcing the boundary belongs to MEM-134.
