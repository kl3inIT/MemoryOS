...
- [Project icons and page polish](docs/increments/active/project-icons-and-page-polish/design.md) owns the persisted project topic icon (V119, Persona icon vocabulary), the five-at-a-time project conversation list, the collapsible project files group and the sidebar focus-ring removal.
