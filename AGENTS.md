...
- [Interactive charts](docs/increments/active/chat-interactive-charts/design.md) owns E2B-style capture of matplotlib figures from `run_python` as chart data plus PNG and their interactive rendering; the `render_gui` tool was removed on 2026-09-19.
