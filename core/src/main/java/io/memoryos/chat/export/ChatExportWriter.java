package io.memoryos.chat.export;
 ...
 */
public final class ChatExportWriter {
    ...
    public static byte[] json(ChatSession session, List<ChatMessage> messages) {
    ...
    public static byte[] html(ChatSession session, List<ChatMessage> messages) {
    ...
    public static byte[] index(List<Entry> entries, List<String> skipped) {
