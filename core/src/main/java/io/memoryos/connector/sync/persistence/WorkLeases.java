...
public final class WorkLeases {
    ...
    public static @org.jspecify.annotations.Nullable Duration initialQueueWait(java.sql.ResultSet row)
    ...
    public static @org.jspecify.annotations.Nullable String safeErrorMessage(
            @org.jspecify.annotations.Nullable String value) {
        return io.memoryos.FailureEvidence.safeErrorMessage(value);
    }

    public static @org.jspecify.annotations.Nullable String safeErrorDetail(
            @org.jspecify.annotations.Nullable String value) {
