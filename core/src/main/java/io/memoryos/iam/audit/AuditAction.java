...
public enum AuditAction {
    ...
    MCP_SERVER_CREATE("mcp_server.create", AuditEventClass.API_ACTIVITY, "transport"),
    MCP_SERVER_UPDATE("mcp_server.update", AuditEventClass.API_ACTIVITY, "transport"),
    MCP_SERVER_DELETE("mcp_server.delete", AuditEventClass.API_ACTIVITY),
    MCP_OAUTH_CLIENT_CHANGE("mcp_oauth_client.change", AuditEventClass.API_ACTIVITY, "change"),
    IDENTITY_PROVIDER_CREATE("identity_provider.create", AuditEventClass.API_ACTIVITY, "alias"),
    IDENTITY_PROVIDER_UPDATE("identity_provider.update", AuditEventClass.API_ACTIVITY, "alias"),
    ...
    SOURCE_CREATE("source.create", AuditEventClass.API_ACTIVITY, "provider", "access"),
    ...
    SOURCE_MANAGER_CHANGE("source.manager_change", AuditEventClass.API_ACTIVITY, "email"),
    ...
    CREDENTIAL_UPDATE("credential.update", AuditEventClass.API_ACTIVITY, "provider", "authentication"),
