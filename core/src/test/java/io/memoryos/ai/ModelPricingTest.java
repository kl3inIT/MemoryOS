...
class ModelPricingTest {
    @Test void cachedInputCostsTheCacheReadRateAndDefaultsToTheInputRate() {
        ...
        var priced = ModelPricing.of(new ModelSettings.Pricing(1.25, 10, 0.125));
        ...
        var unpricedCache = ModelPricing.of(new ModelSettings.Pricing(1.25, 10));
        ...
        var paidCache = ModelPricing.of(new ModelSettings.Pricing(0, 10, 0.5));
