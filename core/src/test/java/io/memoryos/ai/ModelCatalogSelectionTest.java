...
class ModelCatalogSelectionTest {
    ...
    @Test void revokedPersonaProviderFallsBackWithoutLeakingIt() {
        ...
        assertEquals(List.of(fixture.defaultId), fixture.defaults());
        assertEquals(1, fixture.access.availableModelsForPersona(fixture.actor, fixture.persona).size());
    }
    ...
    @Test void agentRestrictedProviderWithoutGroupsIsUsableThroughItsAgentsOnly() {
        ...
        assertEquals(2, fixture.access.availableModelsForPersona(fixture.actor, fixture.persona).size());
    ...
    @Test void namingFlowUsesItsEligibleModelAndOtherwiseTheConversationModel() {
        ...
        when(fixture.catalog.provider(fixture.tenant, restricted.id())).thenReturn(Optional.of(restricted));
        selected = fixture.access.selectFlow(fixture.actor, fixture.session, ModelFlow.CHAT_NAMING);
    ...
    private static final class Fixture {
        ...
        Fixture() {
            ...
            when(adapter.credentialRequirement()).thenReturn(ProviderAdapter.CredentialRequirement.NONE);
            ...
            access = new ChatModelAccess(service, agents, chats, tenants, authorization);
        }
        ...
        List<UUID> defaults() {
            return access.availableModelsForPersona(actor, persona).stream().filter(ModelCatalogService.AvailableModel::isDefault)
