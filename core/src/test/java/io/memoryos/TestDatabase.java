...
public final class TestDatabase {
    ...
    public static JpaHarness jpa(DataSource dataSource, boolean validateSchema) {
        ...
        factoryBean.setPackagesToScan("io.memoryos.iam", "io.memoryos.ai.persistence", "io.memoryos.chat.persistence", "io.memoryos.mcp.persistence", "io.memoryos.voice.persistence");
