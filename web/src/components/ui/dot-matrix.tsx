...
const STATES = {
  idle: { color: "text-content-muted", base: 0.3 },
  loading: {
    blink: (i) => ({
  ...
  recording: {
    color: "text-status-danger-strong",
    glyph: RECORD,
    dim: 0.12,
    blink: () => ({ duration: 1.4, delay: 0, lo: 0.3 }),
  },
  success: { color: "text-status-success-strong", glyph: CHECK },
  error: {
    color: "text-status-danger-strong",
    glyph: CROSS,
  ...
  warning: {
    color: "text-status-warning-strong",
    glyph: BANG,
    blink: () => ({ duration: 1.6, delay: 0, lo: 0.45 }),
  },
  info: { color: "text-status-info-strong", glyph: INFO },
  paused: { color: "text-content-muted", glyph: PAUSE },
  stopped: { color: "text-content-muted", glyph: STOP },
  offline: { color: "text-content-muted", base: 0.15 },
