 ...
 */
export const testChatProviderMutation = (options?: Partial<Options<TestChatProviderData>>): UseMutationOptions<unknown, TestChatProviderError, Options<TestChatProviderData>> => {
    const mutationOptions: UseMutationOptions<unknown, TestChatProviderError, Options<TestChatProviderData>> = {
        mutationFn: async (fnOptions) => {
