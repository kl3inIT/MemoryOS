...
/**
 * Return an archived conversation to the regular list
 */
...
/**
 * Hide an owned conversation from the regular list and history search
 */
...
/**
 * List the actor's private chat sessions, regular by default
 */
