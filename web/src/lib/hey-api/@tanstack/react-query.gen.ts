...
import { acceptAllMeetingCorrections, acceptMeetingCorrection, activateUser, addGroupMembers, addMeetingMinutesItem, archiveAllChatSessions, archiveChatSession, assignGroupManager, assignSourceManager, bookmarkMeetingMoment, branchChatSession, cancelChatMessage, cancelSearchFutureGeneration, changeChatLibraryFile, configureChatSession, copyChatLibraryFile, correctMeetingWords, createAiUsageLimit, createChatModel, createChatPersona, createChatPersonaLabel, createChatProject, createChatPromptShortcut, createChatProvider, createChatSession, createChatVoiceTicket, createDocumentSet, createEmbeddingProvider, createFileSource, createGoogleDriveServiceAccount, createGoogleDriveSource, createGroup, createIdentityProvider, createInvitation, createMcpServer, createMcpServerOAuthClient, createMeeting, createMeetingTicket, createProjectChatSession, createPublicChatPromptShortcut, createSearchFutureGeneration, createSharePointCredential, createSharePointSource, deactivateUser, deleteAiUsageLimit, deleteAllChatSessions, deleteChatFile, deleteChatFileArtifact, deleteChatImageArtifact, deleteChatModel, deleteChatPersona, deleteChatPersonaLabel, deleteChatProject, deleteChatPromptShortcut, deleteChatProvider, deleteChatSession, deleteChatVoiceConnection, deleteDocumentSet, deleteEmbeddingProvider, deleteGoogleDriveCredential, deleteGroup, deleteIdentityProvider, deleteMcpServer, deleteMcpServerOAuthClient, deleteMeeting, deletePublicChatPromptShortcut, deleteSharePointCredential, deleteSource, disconnectMcpConnection, disconnectMcpServerOAuth, discoverGoogleDriveLinkedDocuments, discoverIdentityProvider, discoverMcpServerOAuth, dismissMeetingSpeakerSuggestion, downloadChatExport, downloadChatFile, downloadChatLibraryArchive, downloadUsageReport, editChatMessage, editMeetingMinutesItem, editMeetingMinutesSummary, emptyChatLibraryTrash, endMeeting, exportAuditEvents, exportChatHistory, exportMeetingMinutes, exportMeetingTranscript, finalizeChatFileUpload, finalizeMeetingRecording, finalizeSourceUpload, generateChatTitle, getAiCostDetail, getAiCostSummary, getAuditCatalog, getAuditEvent, getChatBranches, getChatExport, getChatFeedback, getChatFile, getChatFileArtifact, getChatFileArtifactChart, getChatFileArtifactPdfPreview, getChatFilePolicy, getChatFileThumbnail, getChatGuardrails, getChatHistory, getChatHistoryTranscript, getChatImageArtifact, getChatImageAvailability, getChatInterpreterHealth, getChatInterpreterSettings, getChatLibraryArchive, getChatLibraryTrashWindow, getChatLibraryUsage, getChatModelDefault, getChatPersona, getChatPersonaAvatar, getChatPreferences, getChatProject, getChatPromptShortcutPreferences, getChatRetention, getChatSession, getChatSettings, getChatSharing, getChatVoiceAvailability, getChatVoiceSettings, getChatWebAvailability, getCurrentIdentity, getCurrentInvitation, getDocumentSet, getGoogleDriveConfiguration, getGoogleDriveSelection, getGoogleDriveSelectionDraft, getGoogleDriveSelectionPolicy, getGoogleDriveSelectionRequest, getGoogleDriveSelectionTree, getGroup, getMcpServer, getMeeting, getMeetingMinutesHeading, getMyAiCosts, getMyAiUsageStanding, getPersonaModel, getSearchDocument, getSearchSettings, getSharedChatHistory, getSharedChatSession, getSharePointConfiguration, getSharePointRoots, getSharePointSelectionPolicy, getSharePointSelectionRequest, getSource, getSourceOperation, getSourceRun, hideChatPromptShortcut, initiateChatFileUpload, initiateSourceUpload, keepMeetingWording, leaveChatPersona, listAiCostBreakdown, listAiCostDays, listAiUsageLimits, listAuditEvents, listAvailableChatModels, listChatExports, listChatFiles, listChatGroupOptions, listChatHistory, listChatImageConnections, listChatImageProviders, listChatLibrary, listChatLibraryArchives, listChatModelFlows, listChatModelPersonas, listChatPersonaLabels, listChatPersonaModels, listChatPersonaPins, listChatPersonas, listChatPersonasForAdministration, listChatPersonaSources, listChatProjects, listChatPromptShortcuts, listChatProviderAdapters, listChatProviders, listChatSessions, listChatVoiceConnections, listChatVoiceProviders, listChatWebConnections, listChatWebEngines, listConfiguredChatModels, listDocumentSets, listEmbeddingModelPresets, listEmbeddingProviders, listGoogleDriveCredentials, listGroupCandidates, listGroupCapabilities, listGroupMembers, listGroups, listGroupSources, listIdentityProviders, listInvitations, listMcpConnections, listMcpGroupOptions, listMcpServerOAuthClients, listMcpServers, listMcpServerTools, listMeetingCorrections, listMeetings, listMeetingTranscribers, listProjectChatSessions, listPublicChatPromptShortcuts, listReportedProviderModels, listSharePointCredentials, listSourceGroupOptions, listSourceGroups, listSourceIndexAttempts, listSourceItems, listSourceRunErrors, listSourceRuns, listSources, listUsageReports, listUsers, markMeetingMinutesItem, moveChatProject, nameMeetingSpeaker, type Options, pauseSource, pinChatReasoningEffort, previewChatFileArtifactSpreadsheet, previewChatFileSpreadsheet, previewChatRetention, proposeMeetingCorrections, publishMeetingMinutes, purgeChatLibraryFile, readChatDocumentOriginal, readChatDocumentPassages, readChatDocumentSpreadsheet, readChatFilePassages, readChatFileText, readSearchDocumentOriginal, readSearchDocumentSpreadsheet, refreshMcpServerTools, regenerateChatMessage, registerMcpServerOAuthClient, reindexSourceItem, removeChatFeedback, removeGroupManager, removeGroupMember, removeGroupSource, removeMeetingBookmark, removeMeetingMinutesItem, removeSourceItem, renameChatPersonaLabel, renameChatSession, renameGroup, renameSharePointCredential, renameSource, reorderChatPersonas, replaceChatPersonaPins, replaceGoogleDriveRoots, replaceGoogleDriveServiceAccount, replaceGroupCapabilities, replaceSharePointCredentialAuthentication, replaceSharePointScope, replaceUserGroups, requestChatExport, requestChatLibraryArchive, requestUsageReport, rerunMeetingMinutes, reserveMeetingRecording, restoreChatLibraryFile, restoreChatPersona, restoreSearchPastGeneration, resumeSource, retryChatFile, revertAllMeetingCorrections, revertMeetingCorrection, revokeGoogleDriveCredential, revokeInvitation, rotateInvitation, saveChatGrounded, saveChatGuardrails, saveChatHistoryVisibility, saveChatImageConnection, saveChatPreferences, saveChatRetention, saveChatSettings, saveChatVoiceConnection, saveChatWebConnection, saveMcpConnectionApiKey, saveMeetingMinutesHeading, searchChatLibraryContent, searchChatSessions, searchDocuments, searchPrincipals, selectChatBranch, selectChatImageProvider, selectChatPersona, selectChatVoiceProvider, selectChatWebProvider, sendChatMessage, setAllMcpServerToolsEnabled, setChatFeedback, setChatModelDefault, setChatModelFlow, setChatPersonaListing, setChatPromptShortcutPreferences, setChatSharing, setCurrentIdentityLanguage, setMcpServerToolEnabled, setPersonaModel, shareChatPersona, shareDocumentSet, shareMeeting, starMeetingUtterance, startGoogleDriveAuthorization, startMcpConnectionAuthorization, startMcpServerOAuthAuthorization, switchSearchFutureGeneration, synchronizeGoogleDriveSource, synchronizeSharePointSource, synthesizeChatVoice, testChatImageConnection, testChatProvider, testChatVoiceConnection, testChatWebConnection, testEmbeddingProvider, testSharePointCredential, transferChatPersona, unarchiveChatSession, unstarMeetingUtterance, updateAiUsageLimit, updateChatInterpreterSettings, updateChatModel, updateChatPersona, updateChatProject, updateChatPromptShortcut, updateChatProvider, updateChatVoiceSettings, updateDocumentSet, updateEmbeddingProvider, updateGoogleDrivePause, updateGoogleDriveSchedule, updateIdentityProvider, updateMcpServer, updateMcpServerOAuthClient, updateMeeting, updateMeetingNotes, updatePublicChatPromptShortcut, updateSharePointPause, updateSharePointSchedule, updateSourceAccess, updateSourceGroups, validateChatModel } from '../sdk.gen';
import type { AcceptAllMeetingCorrectionsData, AcceptAllMeetingCorrectionsError, AcceptAllMeetingCorrectionsResponse, AcceptMeetingCorrectionData, AcceptMeetingCorrectionError, AcceptMeetingCorrectionResponse, ActivateUserData, ActivateUserError, ActivateUserResponse, AddGroupMembersData, AddGroupMembersResponse, AddMeetingMinutesItemData, AddMeetingMinutesItemError, AddMeetingMinutesItemResponse, ArchiveAllChatSessionsData, ArchiveAllChatSessionsError, ArchiveAllChatSessionsResponse, ArchiveChatSessionData, ArchiveChatSessionError, ArchiveChatSessionResponse, AssignGroupManagerData, AssignGroupManagerResponse, AssignSourceManagerData, AssignSourceManagerResponse, BookmarkMeetingMomentData, BookmarkMeetingMomentError, BookmarkMeetingMomentResponse, BranchChatSessionData, BranchChatSessionError, BranchChatSessionResponse, CancelChatMessageData, CancelChatMessageError, CancelChatMessageResponse, CancelSearchFutureGenerationData, CancelSearchFutureGenerationError, CancelSearchFutureGenerationResponse, ChangeChatLibraryFileData, ChangeChatLibraryFileError, ChangeChatLibraryFileResponse, ConfigureChatSessionData, ConfigureChatSessionError, ConfigureChatSessionResponse, CopyChatLibraryFileData, CopyChatLibraryFileError, CopyChatLibraryFileResponse, CorrectMeetingWordsData, CorrectMeetingWordsError, CorrectMeetingWordsResponse, CreateAiUsageLimitData, CreateAiUsageLimitError, CreateAiUsageLimitResponse, CreateChatModelData, CreateChatModelError, CreateChatModelResponse, CreateChatPersonaData, CreateChatPersonaError, CreateChatPersonaLabelData, CreateChatPersonaLabelError, CreateChatPersonaLabelResponse, CreateChatPersonaResponse, CreateChatProjectData, CreateChatProjectError, CreateChatProjectResponse, CreateChatPromptShortcutData, CreateChatPromptShortcutError, CreateChatPromptShortcutResponse, CreateChatProviderData, CreateChatProviderError, CreateChatProviderResponse, CreateChatSessionData, CreateChatSessionError, CreateChatSessionResponse, CreateChatVoiceTicketData, CreateChatVoiceTicketError, CreateChatVoiceTicketResponse, CreateDocumentSetData, CreateDocumentSetError, CreateDocumentSetResponse, CreateEmbeddingProviderData, CreateEmbeddingProviderError, CreateEmbeddingProviderResponse, CreateFileSourceData, CreateFileSourceResponse, CreateGoogleDriveServiceAccountData, CreateGoogleDriveServiceAccountResponse, CreateGoogleDriveSourceData, CreateGoogleDriveSourceResponse, CreateGroupData, CreateGroupResponse, CreateIdentityProviderData, CreateIdentityProviderError, CreateIdentityProviderResponse, CreateInvitationData, CreateInvitationError, CreateInvitationResponse, CreateMcpServerData, CreateMcpServerError, CreateMcpServerOAuthClientData, CreateMcpServerOAuthClientError, CreateMcpServerOAuthClientResponse, CreateMcpServerResponse, CreateMeetingData, CreateMeetingError, CreateMeetingResponse, CreateMeetingTicketData, CreateMeetingTicketError, CreateMeetingTicketResponse, CreateProjectChatSessionData, CreateProjectChatSessionError, CreateProjectChatSessionResponse, CreatePublicChatPromptShortcutData, CreatePublicChatPromptShortcutError, CreatePublicChatPromptShortcutResponse, CreateSearchFutureGenerationData, CreateSearchFutureGenerationError, CreateSearchFutureGenerationResponse, CreateSharePointCredentialData, CreateSharePointCredentialError, CreateSharePointCredentialResponse, CreateSharePointSourceData, CreateSharePointSourceError, CreateSharePointSourceResponse, DeactivateUserData, DeactivateUserError, DeactivateUserResponse, DeleteAiUsageLimitData, DeleteAiUsageLimitError, DeleteAiUsageLimitResponse, DeleteAllChatSessionsData, DeleteAllChatSessionsError, DeleteAllChatSessionsResponse, DeleteChatFileArtifactData, DeleteChatFileArtifactError, DeleteChatFileArtifactResponse, DeleteChatFileData, DeleteChatFileError, DeleteChatFileResponse, DeleteChatImageArtifactData, DeleteChatImageArtifactError, DeleteChatImageArtifactResponse, DeleteChatModelData, DeleteChatModelError, DeleteChatModelResponse, DeleteChatPersonaData, DeleteChatPersonaError, DeleteChatPersonaLabelData, DeleteChatPersonaLabelError, DeleteChatPersonaLabelResponse, DeleteChatPersonaResponse, DeleteChatProjectData, DeleteChatProjectError, DeleteChatProjectResponse, DeleteChatPromptShortcutData, DeleteChatPromptShortcutError, DeleteChatPromptShortcutResponse, DeleteChatProviderData, DeleteChatProviderError, DeleteChatProviderResponse, DeleteChatSessionData, DeleteChatSessionError, DeleteChatSessionResponse, DeleteChatVoiceConnectionData, DeleteChatVoiceConnectionError, DeleteChatVoiceConnectionResponse, DeleteDocumentSetData, DeleteDocumentSetError, DeleteDocumentSetResponse, DeleteEmbeddingProviderData, DeleteEmbeddingProviderError, DeleteEmbeddingProviderResponse, DeleteGoogleDriveCredentialData, DeleteGoogleDriveCredentialResponse, DeleteGroupData, DeleteGroupError, DeleteGroupResponse, DeleteIdentityProviderData, DeleteIdentityProviderError, DeleteIdentityProviderResponse, DeleteMcpServerData, DeleteMcpServerError, DeleteMcpServerOAuthClientData, DeleteMcpServerOAuthClientError, DeleteMcpServerOAuthClientResponse, DeleteMcpServerResponse, DeleteMeetingData, DeleteMeetingError, DeleteMeetingResponse, DeletePublicChatPromptShortcutData, DeletePublicChatPromptShortcutError, DeletePublicChatPromptShortcutResponse, DeleteSharePointCredentialData, DeleteSharePointCredentialError, DeleteSharePointCredentialResponse, DeleteSourceData, DeleteSourceResponse, DisconnectMcpConnectionData, DisconnectMcpConnectionError, DisconnectMcpConnectionResponse, DisconnectMcpServerOAuthData, DisconnectMcpServerOAuthError, DisconnectMcpServerOAuthResponse, DiscoverGoogleDriveLinkedDocumentsData, DiscoverGoogleDriveLinkedDocumentsResponse, DiscoverIdentityProviderData, DiscoverIdentityProviderError, DiscoverIdentityProviderResponse, DiscoverMcpServerOAuthData, DiscoverMcpServerOAuthError, DiscoverMcpServerOAuthResponse, DismissMeetingSpeakerSuggestionData, DismissMeetingSpeakerSuggestionError, DismissMeetingSpeakerSuggestionResponse, DownloadChatExportData, DownloadChatExportError, DownloadChatExportResponse, DownloadChatFileData, DownloadChatFileError, DownloadChatFileResponse, DownloadChatLibraryArchiveData, DownloadChatLibraryArchiveError, DownloadChatLibraryArchiveResponse, DownloadUsageReportData, DownloadUsageReportError, DownloadUsageReportResponse, EditChatMessageData, EditChatMessageError, EditChatMessageResponse, EditMeetingMinutesItemData, EditMeetingMinutesItemError, EditMeetingMinutesItemResponse, EditMeetingMinutesSummaryData, EditMeetingMinutesSummaryError, EditMeetingMinutesSummaryResponse, EmptyChatLibraryTrashData, EmptyChatLibraryTrashError, EmptyChatLibraryTrashResponse, EndMeetingData, EndMeetingError, EndMeetingResponse, ExportAuditEventsData, ExportAuditEventsError, ExportAuditEventsResponse, ExportChatHistoryData, ExportChatHistoryError, ExportChatHistoryResponse, ExportMeetingMinutesData, ExportMeetingMinutesError, ExportMeetingMinutesResponse, ExportMeetingTranscriptData, ExportMeetingTranscriptError, ExportMeetingTranscriptResponse, FinalizeChatFileUploadData, FinalizeChatFileUploadError, FinalizeChatFileUploadResponse, FinalizeMeetingRecordingData, FinalizeMeetingRecordingError, FinalizeMeetingRecordingResponse, FinalizeSourceUploadData, FinalizeSourceUploadResponse, GenerateChatTitleData, GenerateChatTitleError, GenerateChatTitleResponse, GetAiCostDetailData, GetAiCostDetailError, GetAiCostDetailResponse, GetAiCostSummaryData, GetAiCostSummaryError, GetAiCostSummaryResponse, GetAuditCatalogData, GetAuditCatalogError, GetAuditCatalogResponse, GetAuditEventData, GetAuditEventError, GetAuditEventResponse, GetChatBranchesData, GetChatBranchesError, GetChatBranchesResponse, GetChatExportData, GetChatExportError, GetChatExportResponse, GetChatFeedbackData, GetChatFeedbackError, GetChatFeedbackResponse, GetChatFileArtifactChartData, GetChatFileArtifactChartError, GetChatFileArtifactChartResponse, GetChatFileArtifactData, GetChatFileArtifactError, GetChatFileArtifactPdfPreviewData, GetChatFileArtifactPdfPreviewError, GetChatFileArtifactPdfPreviewResponse, GetChatFileArtifactResponse, GetChatFileData, GetChatFileError, GetChatFilePolicyData, GetChatFilePolicyError, GetChatFilePolicyResponse, GetChatFileResponse, GetChatFileThumbnailData, GetChatFileThumbnailError, GetChatFileThumbnailResponse, GetChatGuardrailsData, GetChatGuardrailsError, GetChatGuardrailsResponse, GetChatHistoryData, GetChatHistoryError, GetChatHistoryResponse, GetChatHistoryTranscriptData, GetChatHistoryTranscriptError, GetChatHistoryTranscriptResponse, GetChatImageArtifactData, GetChatImageArtifactError, GetChatImageArtifactResponse, GetChatImageAvailabilityData, GetChatImageAvailabilityError, GetChatImageAvailabilityResponse, GetChatInterpreterHealthData, GetChatInterpreterHealthError, GetChatInterpreterHealthResponse, GetChatInterpreterSettingsData, GetChatInterpreterSettingsError, GetChatInterpreterSettingsResponse, GetChatLibraryArchiveData, GetChatLibraryArchiveError, GetChatLibraryArchiveResponse, GetChatLibraryTrashWindowData, GetChatLibraryTrashWindowError, GetChatLibraryTrashWindowResponse, GetChatLibraryUsageData, GetChatLibraryUsageError, GetChatLibraryUsageResponse, GetChatModelDefaultData, GetChatModelDefaultError, GetChatModelDefaultResponse, GetChatPersonaAvatarData, GetChatPersonaAvatarError, GetChatPersonaAvatarResponse, GetChatPersonaData, GetChatPersonaError, GetChatPersonaResponse, GetChatPreferencesData, GetChatPreferencesError, GetChatPreferencesResponse, GetChatProjectData, GetChatProjectError, GetChatProjectResponse, GetChatPromptShortcutPreferencesData, GetChatPromptShortcutPreferencesError, GetChatPromptShortcutPreferencesResponse, GetChatRetentionData, GetChatRetentionError, GetChatRetentionResponse, GetChatSessionData, GetChatSessionError, GetChatSessionResponse, GetChatSettingsData, GetChatSettingsError, GetChatSettingsResponse, GetChatSharingData, GetChatSharingError, GetChatSharingResponse, GetChatVoiceAvailabilityData, GetChatVoiceAvailabilityError, GetChatVoiceAvailabilityResponse, GetChatVoiceSettingsData, GetChatVoiceSettingsError, GetChatVoiceSettingsResponse, GetChatWebAvailabilityData, GetChatWebAvailabilityError, GetChatWebAvailabilityResponse, GetCurrentIdentityData, GetCurrentIdentityResponse, GetCurrentInvitationData, GetCurrentInvitationError, GetCurrentInvitationResponse, GetDocumentSetData, GetDocumentSetError, GetDocumentSetResponse, GetGoogleDriveConfigurationData, GetGoogleDriveConfigurationResponse, GetGoogleDriveSelectionData, GetGoogleDriveSelectionDraftData, GetGoogleDriveSelectionDraftResponse, GetGoogleDriveSelectionPolicyData, GetGoogleDriveSelectionPolicyResponse, GetGoogleDriveSelectionRequestData, GetGoogleDriveSelectionRequestResponse, GetGoogleDriveSelectionResponse, GetGoogleDriveSelectionTreeData, GetGoogleDriveSelectionTreeResponse, GetGroupData, GetGroupResponse, GetMcpServerData, GetMcpServerError, GetMcpServerResponse, GetMeetingData, GetMeetingError, GetMeetingMinutesHeadingData, GetMeetingMinutesHeadingError, GetMeetingMinutesHeadingResponse, GetMeetingResponse, GetMyAiCostsData, GetMyAiCostsError, GetMyAiCostsResponse, GetMyAiUsageStandingData, GetMyAiUsageStandingError, GetMyAiUsageStandingResponse, GetPersonaModelData, GetPersonaModelError, GetPersonaModelResponse, GetSearchDocumentData, GetSearchDocumentResponse, GetSearchSettingsData, GetSearchSettingsError, GetSearchSettingsResponse, GetSharedChatHistoryData, GetSharedChatHistoryError, GetSharedChatHistoryResponse, GetSharedChatSessionData, GetSharedChatSessionError, GetSharedChatSessionResponse, GetSharePointConfigurationData, GetSharePointConfigurationError, GetSharePointConfigurationResponse, GetSharePointRootsData, GetSharePointRootsError, GetSharePointRootsResponse, GetSharePointSelectionPolicyData, GetSharePointSelectionPolicyError, GetSharePointSelectionPolicyResponse, GetSharePointSelectionRequestData, GetSharePointSelectionRequestError, GetSharePointSelectionRequestResponse, GetSourceData, GetSourceOperationData, GetSourceOperationResponse, GetSourceResponse, GetSourceRunData, GetSourceRunResponse, HideChatPromptShortcutData, HideChatPromptShortcutError, HideChatPromptShortcutResponse, InitiateChatFileUploadData, InitiateChatFileUploadError, InitiateChatFileUploadResponse, InitiateSourceUploadData, InitiateSourceUploadResponse, KeepMeetingWordingData, KeepMeetingWordingError, KeepMeetingWordingResponse, LeaveChatPersonaData, LeaveChatPersonaError, LeaveChatPersonaResponse, ListAiCostBreakdownData, ListAiCostBreakdownError, ListAiCostBreakdownResponse, ListAiCostDaysData, ListAiCostDaysError, ListAiCostDaysResponse, ListAiUsageLimitsData, ListAiUsageLimitsError, ListAiUsageLimitsResponse, ListAuditEventsData, ListAuditEventsError, ListAuditEventsResponse, ListAvailableChatModelsData, ListAvailableChatModelsError, ListAvailableChatModelsResponse, ListChatExportsData, ListChatExportsError, ListChatExportsResponse, ListChatFilesData, ListChatFilesError, ListChatFilesResponse, ListChatGroupOptionsData, ListChatGroupOptionsError, ListChatGroupOptionsResponse, ListChatHistoryData, ListChatHistoryError, ListChatHistoryResponse, ListChatImageConnectionsData, ListChatImageConnectionsError, ListChatImageConnectionsResponse, ListChatImageProvidersData, ListChatImageProvidersError, ListChatImageProvidersResponse, ListChatLibraryArchivesData, ListChatLibraryArchivesError, ListChatLibraryArchivesResponse, ListChatLibraryData, ListChatLibraryError, ListChatLibraryResponse, ListChatModelFlowsData, ListChatModelFlowsError, ListChatModelFlowsResponse, ListChatModelPersonasData, ListChatModelPersonasError, ListChatModelPersonasResponse, ListChatPersonaLabelsData, ListChatPersonaLabelsError, ListChatPersonaLabelsResponse, ListChatPersonaModelsData, ListChatPersonaModelsError, ListChatPersonaModelsResponse, ListChatPersonaPinsData, ListChatPersonaPinsError, ListChatPersonaPinsResponse, ListChatPersonasData, ListChatPersonasError, ListChatPersonasForAdministrationData, ListChatPersonasForAdministrationError, ListChatPersonasForAdministrationResponse, ListChatPersonaSourcesData, ListChatPersonaSourcesError, ListChatPersonaSourcesResponse, ListChatPersonasResponse, ListChatProjectsData, ListChatProjectsError, ListChatProjectsResponse, ListChatPromptShortcutsData, ListChatPromptShortcutsError, ListChatPromptShortcutsResponse, ListChatProviderAdaptersData, ListChatProviderAdaptersError, ListChatProviderAdaptersResponse, ListChatProvidersData, ListChatProvidersError, ListChatProvidersResponse, ListChatSessionsData, ListChatSessionsError, ListChatSessionsResponse, ListChatVoiceConnectionsData, ListChatVoiceConnectionsError, ListChatVoiceConnectionsResponse, ListChatVoiceProvidersData, ListChatVoiceProvidersError, ListChatVoiceProvidersResponse, ListChatWebConnectionsData, ListChatWebConnectionsError, ListChatWebConnectionsResponse, ListChatWebEnginesData, ListChatWebEnginesError, ListChatWebEnginesResponse, ListConfiguredChatModelsData, ListConfiguredChatModelsError, ListConfiguredChatModelsResponse, ListDocumentSetsData, ListDocumentSetsError, ListDocumentSetsResponse, ListEmbeddingModelPresetsData, ListEmbeddingModelPresetsError, ListEmbeddingModelPresetsResponse, ListEmbeddingProvidersData, ListEmbeddingProvidersError, ListEmbeddingProvidersResponse, ListGoogleDriveCredentialsData, ListGoogleDriveCredentialsResponse, ListGroupCandidatesData, ListGroupCandidatesResponse, ListGroupCapabilitiesData, ListGroupCapabilitiesResponse, ListGroupMembersData, ListGroupMembersResponse, ListGroupsData, ListGroupsError, ListGroupSourcesData, ListGroupSourcesResponse, ListGroupsResponse, ListIdentityProvidersData, ListIdentityProvidersError, ListIdentityProvidersResponse, ListInvitationsData, ListInvitationsError, ListInvitationsResponse, ListMcpConnectionsData, ListMcpConnectionsError, ListMcpConnectionsResponse, ListMcpGroupOptionsData, ListMcpGroupOptionsError, ListMcpGroupOptionsResponse, ListMcpServerOAuthClientsData, ListMcpServerOAuthClientsError, ListMcpServerOAuthClientsResponse, ListMcpServersData, ListMcpServersError, ListMcpServersResponse, ListMcpServerToolsData, ListMcpServerToolsError, ListMcpServerToolsResponse, ListMeetingCorrectionsData, ListMeetingCorrectionsError, ListMeetingCorrectionsResponse, ListMeetingsData, ListMeetingsError, ListMeetingsResponse, ListMeetingTranscribersData, ListMeetingTranscribersError, ListMeetingTranscribersResponse, ListProjectChatSessionsData, ListProjectChatSessionsError, ListProjectChatSessionsResponse, ListPublicChatPromptShortcutsData, ListPublicChatPromptShortcutsError, ListPublicChatPromptShortcutsResponse, ListReportedProviderModelsData, ListReportedProviderModelsError, ListReportedProviderModelsResponse, ListSharePointCredentialsData, ListSharePointCredentialsError, ListSharePointCredentialsResponse, ListSourceGroupOptionsData, ListSourceGroupOptionsResponse, ListSourceGroupsData, ListSourceGroupsResponse, ListSourceIndexAttemptsData, ListSourceIndexAttemptsResponse, ListSourceItemsData, ListSourceItemsResponse, ListSourceRunErrorsData, ListSourceRunErrorsResponse, ListSourceRunsData, ListSourceRunsResponse, ListSourcesData, ListSourcesResponse, ListUsageReportsData, ListUsageReportsError, ListUsageReportsResponse, ListUsersData, ListUsersError, ListUsersResponse, MarkMeetingMinutesItemData, MarkMeetingMinutesItemError, MarkMeetingMinutesItemResponse, MoveChatProjectData, MoveChatProjectError, MoveChatProjectResponse, NameMeetingSpeakerData, NameMeetingSpeakerError, NameMeetingSpeakerResponse, PauseSourceData, PauseSourceResponse, PinChatReasoningEffortData, PinChatReasoningEffortError, PinChatReasoningEffortResponse, PreviewChatFileArtifactSpreadsheetData, PreviewChatFileArtifactSpreadsheetError, PreviewChatFileArtifactSpreadsheetResponse, PreviewChatFileSpreadsheetData, PreviewChatFileSpreadsheetError, PreviewChatFileSpreadsheetResponse, PreviewChatRetentionData, PreviewChatRetentionError, PreviewChatRetentionResponse, ProposeMeetingCorrectionsData, ProposeMeetingCorrectionsError, ProposeMeetingCorrectionsResponse, PublishMeetingMinutesData, PublishMeetingMinutesError, PublishMeetingMinutesResponse, PurgeChatLibraryFileData, PurgeChatLibraryFileError, PurgeChatLibraryFileResponse, ReadChatDocumentOriginalData, ReadChatDocumentOriginalError, ReadChatDocumentOriginalResponse, ReadChatDocumentPassagesData, ReadChatDocumentPassagesError, ReadChatDocumentPassagesResponse, ReadChatDocumentSpreadsheetData, ReadChatDocumentSpreadsheetError, ReadChatDocumentSpreadsheetResponse, ReadChatFilePassagesData, ReadChatFilePassagesError, ReadChatFilePassagesResponse, ReadChatFileTextData, ReadChatFileTextError, ReadChatFileTextResponse, ReadSearchDocumentOriginalData, ReadSearchDocumentOriginalResponse, ReadSearchDocumentSpreadsheetData, ReadSearchDocumentSpreadsheetResponse, RefreshMcpServerToolsData, RefreshMcpServerToolsError, RefreshMcpServerToolsResponse, RegenerateChatMessageData, RegenerateChatMessageError, RegenerateChatMessageResponse, RegisterMcpServerOAuthClientData, RegisterMcpServerOAuthClientError, RegisterMcpServerOAuthClientResponse, ReindexSourceItemData, ReindexSourceItemResponse, RemoveChatFeedbackData, RemoveChatFeedbackError, RemoveChatFeedbackResponse, RemoveGroupManagerData, RemoveGroupManagerResponse, RemoveGroupMemberData, RemoveGroupMemberError, RemoveGroupMemberResponse, RemoveGroupSourceData, RemoveGroupSourceResponse, RemoveMeetingBookmarkData, RemoveMeetingBookmarkError, RemoveMeetingBookmarkResponse, RemoveMeetingMinutesItemData, RemoveMeetingMinutesItemError, RemoveMeetingMinutesItemResponse, RemoveSourceItemData, RemoveSourceItemResponse, RenameChatPersonaLabelData, RenameChatPersonaLabelError, RenameChatPersonaLabelResponse, RenameChatSessionData, RenameChatSessionError, RenameChatSessionResponse, RenameGroupData, RenameGroupResponse, RenameSharePointCredentialData, RenameSharePointCredentialError, RenameSharePointCredentialResponse, RenameSourceData, RenameSourceResponse, ReorderChatPersonasData, ReorderChatPersonasError, ReorderChatPersonasResponse, ReplaceChatPersonaPinsData, ReplaceChatPersonaPinsError, ReplaceChatPersonaPinsResponse, ReplaceGoogleDriveRootsData, ReplaceGoogleDriveRootsResponse, ReplaceGoogleDriveServiceAccountData, ReplaceGoogleDriveServiceAccountResponse, ReplaceGroupCapabilitiesData, ReplaceGroupCapabilitiesResponse, ReplaceSharePointCredentialAuthenticationData, ReplaceSharePointCredentialAuthenticationError, ReplaceSharePointCredentialAuthenticationResponse, ReplaceSharePointScopeData, ReplaceSharePointScopeError, ReplaceSharePointScopeResponse, ReplaceUserGroupsData, ReplaceUserGroupsError, ReplaceUserGroupsResponse, RequestChatExportData, RequestChatExportError, RequestChatExportResponse, RequestChatLibraryArchiveData, RequestChatLibraryArchiveError, RequestChatLibraryArchiveResponse, RequestUsageReportData, RequestUsageReportError, RequestUsageReportResponse, RerunMeetingMinutesData, RerunMeetingMinutesError, RerunMeetingMinutesResponse, ReserveMeetingRecordingData, ReserveMeetingRecordingError, ReserveMeetingRecordingResponse, RestoreChatLibraryFileData, RestoreChatLibraryFileError, RestoreChatLibraryFileResponse, RestoreChatPersonaData, RestoreChatPersonaError, RestoreChatPersonaResponse, RestoreSearchPastGenerationData, RestoreSearchPastGenerationError, RestoreSearchPastGenerationResponse, ResumeSourceData, ResumeSourceResponse, RetryChatFileData, RetryChatFileError, RetryChatFileResponse, RevertAllMeetingCorrectionsData, RevertAllMeetingCorrectionsError, RevertAllMeetingCorrectionsResponse, RevertMeetingCorrectionData, RevertMeetingCorrectionError, RevertMeetingCorrectionResponse, RevokeGoogleDriveCredentialData, RevokeGoogleDriveCredentialResponse, RevokeInvitationData, RevokeInvitationError, RevokeInvitationResponse, RotateInvitationData, RotateInvitationError, RotateInvitationResponse, SaveChatGroundedData, SaveChatGroundedError, SaveChatGroundedResponse, SaveChatGuardrailsData, SaveChatGuardrailsError, SaveChatGuardrailsResponse, SaveChatHistoryVisibilityData, SaveChatHistoryVisibilityError, SaveChatHistoryVisibilityResponse, SaveChatImageConnectionData, SaveChatImageConnectionError, SaveChatImageConnectionResponse, SaveChatPreferencesData, SaveChatPreferencesError, SaveChatPreferencesResponse, SaveChatRetentionData, SaveChatRetentionError, SaveChatRetentionResponse, SaveChatSettingsData, SaveChatSettingsError, SaveChatSettingsResponse, SaveChatVoiceConnectionData, SaveChatVoiceConnectionError, SaveChatVoiceConnectionResponse, SaveChatWebConnectionData, SaveChatWebConnectionError, SaveChatWebConnectionResponse, SaveMcpConnectionApiKeyData, SaveMcpConnectionApiKeyError, SaveMcpConnectionApiKeyResponse, SaveMeetingMinutesHeadingData, SaveMeetingMinutesHeadingError, SaveMeetingMinutesHeadingResponse, SearchChatLibraryContentData, SearchChatLibraryContentError, SearchChatLibraryContentResponse, SearchChatSessionsData, SearchChatSessionsError, SearchChatSessionsResponse, SearchDocumentsData, SearchDocumentsResponse, SearchPrincipalsData, SearchPrincipalsError, SearchPrincipalsResponse, SelectChatBranchData, SelectChatBranchError, SelectChatBranchResponse, SelectChatImageProviderData, SelectChatImageProviderError, SelectChatImageProviderResponse, SelectChatPersonaData, SelectChatPersonaError, SelectChatPersonaResponse, SelectChatVoiceProviderData, SelectChatVoiceProviderError, SelectChatVoiceProviderResponse, SelectChatWebProviderData, SelectChatWebProviderError, SelectChatWebProviderResponse, SendChatMessageData, SendChatMessageError, SendChatMessageResponse, SetAllMcpServerToolsEnabledData, SetAllMcpServerToolsEnabledError, SetAllMcpServerToolsEnabledResponse, SetChatFeedbackData, SetChatFeedbackError, SetChatFeedbackResponse, SetChatModelDefaultData, SetChatModelDefaultError, SetChatModelDefaultResponse, SetChatModelFlowData, SetChatModelFlowError, SetChatModelFlowResponse, SetChatPersonaListingData, SetChatPersonaListingError, SetChatPersonaListingResponse, SetChatPromptShortcutPreferencesData, SetChatPromptShortcutPreferencesError, SetChatPromptShortcutPreferencesResponse, SetChatSharingData, SetChatSharingError, SetChatSharingResponse, SetCurrentIdentityLanguageData, SetCurrentIdentityLanguageResponse, SetMcpServerToolEnabledData, SetMcpServerToolEnabledError, SetMcpServerToolEnabledResponse, SetPersonaModelData, SetPersonaModelError, SetPersonaModelResponse, ShareChatPersonaData, ShareChatPersonaError, ShareChatPersonaResponse, ShareDocumentSetData, ShareDocumentSetError, ShareDocumentSetResponse, ShareMeetingData, ShareMeetingError, ShareMeetingResponse, StarMeetingUtteranceData, StarMeetingUtteranceError, StarMeetingUtteranceResponse, StartGoogleDriveAuthorizationData, StartGoogleDriveAuthorizationResponse, StartMcpConnectionAuthorizationData, StartMcpConnectionAuthorizationError, StartMcpConnectionAuthorizationResponse, StartMcpServerOAuthAuthorizationData, StartMcpServerOAuthAuthorizationError, StartMcpServerOAuthAuthorizationResponse, SwitchSearchFutureGenerationData, SwitchSearchFutureGenerationError, SwitchSearchFutureGenerationResponse, SynchronizeGoogleDriveSourceData, SynchronizeGoogleDriveSourceResponse, SynchronizeSharePointSourceData, SynchronizeSharePointSourceError, SynchronizeSharePointSourceResponse, SynthesizeChatVoiceData, SynthesizeChatVoiceError, SynthesizeChatVoiceResponse, TestChatImageConnectionData, TestChatImageConnectionError, TestChatImageConnectionResponse, TestChatProviderData, TestChatProviderError, TestChatProviderResponse, TestChatVoiceConnectionData, TestChatVoiceConnectionError, TestChatVoiceConnectionResponse, TestChatWebConnectionData, TestChatWebConnectionError, TestChatWebConnectionResponse, TestEmbeddingProviderData, TestEmbeddingProviderError, TestEmbeddingProviderResponse, TestSharePointCredentialData, TestSharePointCredentialError, TestSharePointCredentialResponse, TransferChatPersonaData, TransferChatPersonaError, TransferChatPersonaResponse, UnarchiveChatSessionData, UnarchiveChatSessionError, UnarchiveChatSessionResponse, UnstarMeetingUtteranceData, UnstarMeetingUtteranceError, UnstarMeetingUtteranceResponse, UpdateAiUsageLimitData, UpdateAiUsageLimitError, UpdateAiUsageLimitResponse, UpdateChatInterpreterSettingsData, UpdateChatInterpreterSettingsError, UpdateChatInterpreterSettingsResponse, UpdateChatModelData, UpdateChatModelError, UpdateChatModelResponse, UpdateChatPersonaData, UpdateChatPersonaError, UpdateChatPersonaResponse, UpdateChatProjectData, UpdateChatProjectError, UpdateChatProjectResponse, UpdateChatPromptShortcutData, UpdateChatPromptShortcutError, UpdateChatPromptShortcutResponse, UpdateChatProviderData, UpdateChatProviderError, UpdateChatProviderResponse, UpdateChatVoiceSettingsData, UpdateChatVoiceSettingsError, UpdateChatVoiceSettingsResponse, UpdateDocumentSetData, UpdateDocumentSetError, UpdateDocumentSetResponse, UpdateEmbeddingProviderData, UpdateEmbeddingProviderError, UpdateEmbeddingProviderResponse, UpdateGoogleDrivePauseData, UpdateGoogleDrivePauseResponse, UpdateGoogleDriveScheduleData, UpdateGoogleDriveScheduleResponse, UpdateIdentityProviderData, UpdateIdentityProviderError, UpdateIdentityProviderResponse, UpdateMcpServerData, UpdateMcpServerError, UpdateMcpServerOAuthClientData, UpdateMcpServerOAuthClientError, UpdateMcpServerOAuthClientResponse, UpdateMcpServerResponse, UpdateMeetingData, UpdateMeetingError, UpdateMeetingNotesData, UpdateMeetingNotesError, UpdateMeetingNotesResponse, UpdateMeetingResponse, UpdatePublicChatPromptShortcutData, UpdatePublicChatPromptShortcutError, UpdatePublicChatPromptShortcutResponse, UpdateSharePointPauseData, UpdateSharePointPauseError, UpdateSharePointPauseResponse, UpdateSharePointScheduleData, UpdateSharePointScheduleError, UpdateSharePointScheduleResponse, UpdateSourceAccessData, UpdateSourceAccessResponse, UpdateSourceGroupsData, UpdateSourceGroupsResponse, ValidateChatModelData, ValidateChatModelError, ValidateChatModelResponse } from '../types.gen';
...
export const getMeetingQueryKey = (options: Options<GetMeetingData>) => createQueryKey('getMeeting', options);
 ...
 */
export const unstarMeetingUtteranceMutation = (options?: Partial<Options<UnstarMeetingUtteranceData>>): UseMutationOptions<UnstarMeetingUtteranceResponse, UnstarMeetingUtteranceError, Options<UnstarMeetingUtteranceData>> => {
    const mutationOptions: UseMutationOptions<UnstarMeetingUtteranceResponse, UnstarMeetingUtteranceError, Options<UnstarMeetingUtteranceData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await unstarMeetingUtterance({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const starMeetingUtteranceMutation = (options?: Partial<Options<StarMeetingUtteranceData>>): UseMutationOptions<StarMeetingUtteranceResponse, StarMeetingUtteranceError, Options<StarMeetingUtteranceData>> => {
    const mutationOptions: UseMutationOptions<StarMeetingUtteranceResponse, StarMeetingUtteranceError, Options<StarMeetingUtteranceData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await starMeetingUtterance({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const nameMeetingSpeakerMutation = (options?: Partial<Options<NameMeetingSpeakerData>>): UseMutationOptions<NameMeetingSpeakerResponse, NameMeetingSpeakerError, Options<NameMeetingSpeakerData>> => {
    const mutationOptions: UseMutationOptions<NameMeetingSpeakerResponse, NameMeetingSpeakerError, Options<NameMeetingSpeakerData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const shareMeetingMutation = (options?: Partial<Options<ShareMeetingData>>): UseMutationOptions<ShareMeetingResponse, ShareMeetingError, Options<ShareMeetingData>> => {
    const mutationOptions: UseMutationOptions<ShareMeetingResponse, ShareMeetingError, Options<ShareMeetingData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await shareMeeting({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const updateMeetingNotesMutation = (options?: Partial<Options<UpdateMeetingNotesData>>): UseMutationOptions<UpdateMeetingNotesResponse, UpdateMeetingNotesError, Options<UpdateMeetingNotesData>> => {
    const mutationOptions: UseMutationOptions<UpdateMeetingNotesResponse, UpdateMeetingNotesError, Options<UpdateMeetingNotesData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const markMeetingMinutesItemMutation = (options?: Partial<Options<MarkMeetingMinutesItemData>>): UseMutationOptions<MarkMeetingMinutesItemResponse, MarkMeetingMinutesItemError, Options<MarkMeetingMinutesItemData>> => {
    const mutationOptions: UseMutationOptions<MarkMeetingMinutesItemResponse, MarkMeetingMinutesItemError, Options<MarkMeetingMinutesItemData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const editMeetingMinutesSummaryMutation = (options?: Partial<Options<EditMeetingMinutesSummaryData>>): UseMutationOptions<EditMeetingMinutesSummaryResponse, EditMeetingMinutesSummaryError, Options<EditMeetingMinutesSummaryData>> => {
    const mutationOptions: UseMutationOptions<EditMeetingMinutesSummaryResponse, EditMeetingMinutesSummaryError, Options<EditMeetingMinutesSummaryData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const removeMeetingMinutesItemMutation = (options?: Partial<Options<RemoveMeetingMinutesItemData>>): UseMutationOptions<RemoveMeetingMinutesItemResponse, RemoveMeetingMinutesItemError, Options<RemoveMeetingMinutesItemData>> => {
    const mutationOptions: UseMutationOptions<RemoveMeetingMinutesItemResponse, RemoveMeetingMinutesItemError, Options<RemoveMeetingMinutesItemData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const editMeetingMinutesItemMutation = (options?: Partial<Options<EditMeetingMinutesItemData>>): UseMutationOptions<EditMeetingMinutesItemResponse, EditMeetingMinutesItemError, Options<EditMeetingMinutesItemData>> => {
    const mutationOptions: UseMutationOptions<EditMeetingMinutesItemResponse, EditMeetingMinutesItemError, Options<EditMeetingMinutesItemData>> = {
        mutationFn: async (fnOptions) => {
...
export const getMeetingMinutesHeadingQueryKey = (options: Options<GetMeetingMinutesHeadingData>) => createQueryKey('getMeetingMinutesHeading', options);

/**
 * The biên bản heading as the owner last saved it
 */
export const getMeetingMinutesHeadingOptions = (options: Options<GetMeetingMinutesHeadingData>) => queryOptions<GetMeetingMinutesHeadingResponse, GetMeetingMinutesHeadingError, GetMeetingMinutesHeadingResponse, ReturnType<typeof getMeetingMinutesHeadingQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getMeetingMinutesHeadingQueryKey(options)
});

/**
 * Keep the biên bản heading the owner typed
 */
export const saveMeetingMinutesHeadingMutation = (options?: Partial<Options<SaveMeetingMinutesHeadingData>>): UseMutationOptions<SaveMeetingMinutesHeadingResponse, SaveMeetingMinutesHeadingError, Options<SaveMeetingMinutesHeadingData>> => {
    const mutationOptions: UseMutationOptions<SaveMeetingMinutesHeadingResponse, SaveMeetingMinutesHeadingError, Options<SaveMeetingMinutesHeadingData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const replaceGoogleDriveServiceAccountMutation = (options?: Partial<Options<ReplaceGoogleDriveServiceAccountData>>): UseMutationOptions<ReplaceGoogleDriveServiceAccountResponse, DefaultError, Options<ReplaceGoogleDriveServiceAccountData>> => {
    const mutationOptions: UseMutationOptions<ReplaceGoogleDriveServiceAccountResponse, DefaultError, Options<ReplaceGoogleDriveServiceAccountData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await replaceGoogleDriveServiceAccount({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const saveChatHistoryVisibilityMutation = (options?: Partial<Options<SaveChatHistoryVisibilityData>>): UseMutationOptions<SaveChatHistoryVisibilityResponse, SaveChatHistoryVisibilityError, Options<SaveChatHistoryVisibilityData>> => {
    const mutationOptions: UseMutationOptions<SaveChatHistoryVisibilityResponse, SaveChatHistoryVisibilityError, Options<SaveChatHistoryVisibilityData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await saveChatHistoryVisibility({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getChatGuardrailsQueryKey = (options?: Options<GetChatGuardrailsData>) => createQueryKey('getChatGuardrails', options);

/**
 * Read the sensitive topics and blocked phrases; requires model management
 */
export const getChatGuardrailsOptions = (options?: Options<GetChatGuardrailsData>) => queryOptions<GetChatGuardrailsResponse, GetChatGuardrailsError, GetChatGuardrailsResponse, ReturnType<typeof getChatGuardrailsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatGuardrails({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatGuardrailsQueryKey(options)
});

/**
 * Change the sensitive topics and blocked phrases; requires model management
 */
export const saveChatGuardrailsMutation = (options?: Partial<Options<SaveChatGuardrailsData>>): UseMutationOptions<SaveChatGuardrailsResponse, SaveChatGuardrailsError, Options<SaveChatGuardrailsData>> => {
    const mutationOptions: UseMutationOptions<SaveChatGuardrailsResponse, SaveChatGuardrailsError, Options<SaveChatGuardrailsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await saveChatGuardrails({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Answer from the organization's documents only; requires model management
 */
export const saveChatGroundedMutation = (options?: Partial<Options<SaveChatGroundedData>>): UseMutationOptions<SaveChatGroundedResponse, SaveChatGroundedError, Options<SaveChatGroundedData>> => {
    const mutationOptions: UseMutationOptions<SaveChatGroundedResponse, SaveChatGroundedError, Options<SaveChatGroundedData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await saveChatGrounded({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getChatRetentionQueryKey = (options?: Options<GetChatRetentionData>) => createQueryKey('getChatRetention', options);

/**
 * Read how long you keep your own conversations
 */
export const getChatRetentionOptions = (options?: Options<GetChatRetentionData>) => queryOptions<GetChatRetentionResponse, GetChatRetentionError, GetChatRetentionResponse, ReturnType<typeof getChatRetentionQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatRetention({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatRetentionQueryKey(options)
});

/**
 * Set or clear how long you keep your own conversations
 */
export const saveChatRetentionMutation = (options?: Partial<Options<SaveChatRetentionData>>): UseMutationOptions<SaveChatRetentionResponse, SaveChatRetentionError, Options<SaveChatRetentionData>> => {
    const mutationOptions: UseMutationOptions<SaveChatRetentionResponse, SaveChatRetentionError, Options<SaveChatRetentionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await saveChatRetention({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const deleteDocumentSetMutation = (options?: Partial<Options<DeleteDocumentSetData>>): UseMutationOptions<DeleteDocumentSetResponse, DeleteDocumentSetError, Options<DeleteDocumentSetData>> => {
    const mutationOptions: UseMutationOptions<DeleteDocumentSetResponse, DeleteDocumentSetError, Options<DeleteDocumentSetData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteDocumentSet({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getDocumentSetQueryKey = (options: Options<GetDocumentSetData>) => createQueryKey('getDocumentSet', options);

/**
 * Read a usable Document Set
 */
export const getDocumentSetOptions = (options: Options<GetDocumentSetData>) => queryOptions<GetDocumentSetResponse, GetDocumentSetError, GetDocumentSetResponse, ReturnType<typeof getDocumentSetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getDocumentSet({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getDocumentSetQueryKey(options)
});

/**
 * Update a Document Set with an expected revision
 */
export const updateDocumentSetMutation = (options?: Partial<Options<UpdateDocumentSetData>>): UseMutationOptions<UpdateDocumentSetResponse, UpdateDocumentSetError, Options<UpdateDocumentSetData>> => {
    const mutationOptions: UseMutationOptions<UpdateDocumentSetResponse, UpdateDocumentSetError, Options<UpdateDocumentSetData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateDocumentSet({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const shareDocumentSetMutation = (options?: Partial<Options<ShareDocumentSetData>>): UseMutationOptions<ShareDocumentSetResponse, ShareDocumentSetError, Options<ShareDocumentSetData>> => {
    const mutationOptions: UseMutationOptions<ShareDocumentSetResponse, ShareDocumentSetError, Options<ShareDocumentSetData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await shareDocumentSet({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const deleteAiUsageLimitMutation = (options?: Partial<Options<DeleteAiUsageLimitData>>): UseMutationOptions<DeleteAiUsageLimitResponse, DeleteAiUsageLimitError, Options<DeleteAiUsageLimitData>> => {
    const mutationOptions: UseMutationOptions<DeleteAiUsageLimitResponse, DeleteAiUsageLimitError, Options<DeleteAiUsageLimitData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteAiUsageLimit({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const updateAiUsageLimitMutation = (options?: Partial<Options<UpdateAiUsageLimitData>>): UseMutationOptions<UpdateAiUsageLimitResponse, UpdateAiUsageLimitError, Options<UpdateAiUsageLimitData>> => {
    const mutationOptions: UseMutationOptions<UpdateAiUsageLimitResponse, UpdateAiUsageLimitError, Options<UpdateAiUsageLimitData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateAiUsageLimit({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listMeetingsQueryKey = (options?: Options<ListMeetingsData>) => createQueryKey('listMeetings', options);
 ...
 */
export const correctMeetingWordsMutation = (options?: Partial<Options<CorrectMeetingWordsData>>): UseMutationOptions<CorrectMeetingWordsResponse, CorrectMeetingWordsError, Options<CorrectMeetingWordsData>> => {
    const mutationOptions: UseMutationOptions<CorrectMeetingWordsResponse, CorrectMeetingWordsError, Options<CorrectMeetingWordsData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const createMeetingTicketMutation = (options?: Partial<Options<CreateMeetingTicketData>>): UseMutationOptions<CreateMeetingTicketResponse, CreateMeetingTicketError, Options<CreateMeetingTicketData>> => {
    const mutationOptions: UseMutationOptions<CreateMeetingTicketResponse, CreateMeetingTicketError, Options<CreateMeetingTicketData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const reserveMeetingRecordingMutation = (options?: Partial<Options<ReserveMeetingRecordingData>>): UseMutationOptions<ReserveMeetingRecordingResponse, ReserveMeetingRecordingError, Options<ReserveMeetingRecordingData>> => {
    const mutationOptions: UseMutationOptions<ReserveMeetingRecordingResponse, ReserveMeetingRecordingError, Options<ReserveMeetingRecordingData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await reserveMeetingRecording({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const finalizeMeetingRecordingMutation = (options?: Partial<Options<FinalizeMeetingRecordingData>>): UseMutationOptions<FinalizeMeetingRecordingResponse, FinalizeMeetingRecordingError, Options<FinalizeMeetingRecordingData>> => {
    const mutationOptions: UseMutationOptions<FinalizeMeetingRecordingResponse, FinalizeMeetingRecordingError, Options<FinalizeMeetingRecordingData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const rerunMeetingMinutesMutation = (options?: Partial<Options<RerunMeetingMinutesData>>): UseMutationOptions<RerunMeetingMinutesResponse, RerunMeetingMinutesError, Options<RerunMeetingMinutesData>> => {
    const mutationOptions: UseMutationOptions<RerunMeetingMinutesResponse, RerunMeetingMinutesError, Options<RerunMeetingMinutesData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const addMeetingMinutesItemMutation = (options?: Partial<Options<AddMeetingMinutesItemData>>): UseMutationOptions<AddMeetingMinutesItemResponse, AddMeetingMinutesItemError, Options<AddMeetingMinutesItemData>> => {
    const mutationOptions: UseMutationOptions<AddMeetingMinutesItemResponse, AddMeetingMinutesItemError, Options<AddMeetingMinutesItemData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const publishMeetingMinutesMutation = (options?: Partial<Options<PublishMeetingMinutesData>>): UseMutationOptions<PublishMeetingMinutesResponse, PublishMeetingMinutesError, Options<PublishMeetingMinutesData>> => {
    const mutationOptions: UseMutationOptions<PublishMeetingMinutesResponse, PublishMeetingMinutesError, Options<PublishMeetingMinutesData>> = {
        mutationFn: async (fnOptions) => {
 ...
 * End recording
 */
export const endMeetingMutation = (options?: Partial<Options<EndMeetingData>>): UseMutationOptions<EndMeetingResponse, EndMeetingError, Options<EndMeetingData>> => {
    const mutationOptions: UseMutationOptions<EndMeetingResponse, EndMeetingError, Options<EndMeetingData>> = {
        mutationFn: async (fnOptions) => {
...
export const listMeetingCorrectionsQueryKey = (options: Options<ListMeetingCorrectionsData>) => createQueryKey('listMeetingCorrections', options);

/**
 * Every proposal made for this meeting, decided or not
 */
export const listMeetingCorrectionsOptions = (options: Options<ListMeetingCorrectionsData>) => queryOptions<ListMeetingCorrectionsResponse, ListMeetingCorrectionsError, ListMeetingCorrectionsResponse, ReturnType<typeof listMeetingCorrectionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listMeetingCorrectionsQueryKey(options)
});

/**
 * Ask a model what the speech provider probably meant at each uncertain stretch
 */
export const proposeMeetingCorrectionsMutation = (options?: Partial<Options<ProposeMeetingCorrectionsData>>): UseMutationOptions<ProposeMeetingCorrectionsResponse, ProposeMeetingCorrectionsError, Options<ProposeMeetingCorrectionsData>> => {
    const mutationOptions: UseMutationOptions<ProposeMeetingCorrectionsResponse, ProposeMeetingCorrectionsError, Options<ProposeMeetingCorrectionsData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const revertMeetingCorrectionMutation = (options?: Partial<Options<RevertMeetingCorrectionData>>): UseMutationOptions<RevertMeetingCorrectionResponse, RevertMeetingCorrectionError, Options<RevertMeetingCorrectionData>> => {
    const mutationOptions: UseMutationOptions<RevertMeetingCorrectionResponse, RevertMeetingCorrectionError, Options<RevertMeetingCorrectionData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const keepMeetingWordingMutation = (options?: Partial<Options<KeepMeetingWordingData>>): UseMutationOptions<KeepMeetingWordingResponse, KeepMeetingWordingError, Options<KeepMeetingWordingData>> => {
    const mutationOptions: UseMutationOptions<KeepMeetingWordingResponse, KeepMeetingWordingError, Options<KeepMeetingWordingData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const acceptMeetingCorrectionMutation = (options?: Partial<Options<AcceptMeetingCorrectionData>>): UseMutationOptions<AcceptMeetingCorrectionResponse, AcceptMeetingCorrectionError, Options<AcceptMeetingCorrectionData>> => {
    const mutationOptions: UseMutationOptions<AcceptMeetingCorrectionResponse, AcceptMeetingCorrectionError, Options<AcceptMeetingCorrectionData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const revertAllMeetingCorrectionsMutation = (options?: Partial<Options<RevertAllMeetingCorrectionsData>>): UseMutationOptions<RevertAllMeetingCorrectionsResponse, RevertAllMeetingCorrectionsError, Options<RevertAllMeetingCorrectionsData>> => {
    const mutationOptions: UseMutationOptions<RevertAllMeetingCorrectionsResponse, RevertAllMeetingCorrectionsError, Options<RevertAllMeetingCorrectionsData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const acceptAllMeetingCorrectionsMutation = (options?: Partial<Options<AcceptAllMeetingCorrectionsData>>): UseMutationOptions<AcceptAllMeetingCorrectionsResponse, AcceptAllMeetingCorrectionsError, Options<AcceptAllMeetingCorrectionsData>> => {
    const mutationOptions: UseMutationOptions<AcceptAllMeetingCorrectionsResponse, AcceptAllMeetingCorrectionsError, Options<AcceptAllMeetingCorrectionsData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const bookmarkMeetingMomentMutation = (options?: Partial<Options<BookmarkMeetingMomentData>>): UseMutationOptions<BookmarkMeetingMomentResponse, BookmarkMeetingMomentError, Options<BookmarkMeetingMomentData>> => {
    const mutationOptions: UseMutationOptions<BookmarkMeetingMomentResponse, BookmarkMeetingMomentError, Options<BookmarkMeetingMomentData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const createGoogleDriveServiceAccountMutation = (options?: Partial<Options<CreateGoogleDriveServiceAccountData>>): UseMutationOptions<CreateGoogleDriveServiceAccountResponse, DefaultError, Options<CreateGoogleDriveServiceAccountData>> => {
    const mutationOptions: UseMutationOptions<CreateGoogleDriveServiceAccountResponse, DefaultError, Options<CreateGoogleDriveServiceAccountData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createGoogleDriveServiceAccount({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const unarchiveChatSessionMutation = (options?: Partial<Options<UnarchiveChatSessionData>>): UseMutationOptions<UnarchiveChatSessionResponse, UnarchiveChatSessionError, Options<UnarchiveChatSessionData>> => {
    const mutationOptions: UseMutationOptions<UnarchiveChatSessionResponse, UnarchiveChatSessionError, Options<UnarchiveChatSessionData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const branchChatSessionMutation = (options?: Partial<Options<BranchChatSessionData>>): UseMutationOptions<BranchChatSessionResponse, BranchChatSessionError, Options<BranchChatSessionData>> => {
    const mutationOptions: UseMutationOptions<BranchChatSessionResponse, BranchChatSessionError, Options<BranchChatSessionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await branchChatSession({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const archiveChatSessionMutation = (options?: Partial<Options<ArchiveChatSessionData>>): UseMutationOptions<ArchiveChatSessionResponse, ArchiveChatSessionError, Options<ArchiveChatSessionData>> => {
    const mutationOptions: UseMutationOptions<ArchiveChatSessionResponse, ArchiveChatSessionError, Options<ArchiveChatSessionData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const archiveAllChatSessionsMutation = (options?: Partial<Options<ArchiveAllChatSessionsData>>): UseMutationOptions<ArchiveAllChatSessionsResponse, ArchiveAllChatSessionsError, Options<ArchiveAllChatSessionsData>> => {
    const mutationOptions: UseMutationOptions<ArchiveAllChatSessionsResponse, ArchiveAllChatSessionsError, Options<ArchiveAllChatSessionsData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const restoreChatLibraryFileMutation = (options?: Partial<Options<RestoreChatLibraryFileData>>): UseMutationOptions<RestoreChatLibraryFileResponse, RestoreChatLibraryFileError, Options<RestoreChatLibraryFileData>> => {
    const mutationOptions: UseMutationOptions<RestoreChatLibraryFileResponse, RestoreChatLibraryFileError, Options<RestoreChatLibraryFileData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await restoreChatLibraryFile({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const purgeChatLibraryFileMutation = (options?: Partial<Options<PurgeChatLibraryFileData>>): UseMutationOptions<PurgeChatLibraryFileResponse, PurgeChatLibraryFileError, Options<PurgeChatLibraryFileData>> => {
    const mutationOptions: UseMutationOptions<PurgeChatLibraryFileResponse, PurgeChatLibraryFileError, Options<PurgeChatLibraryFileData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await purgeChatLibraryFile({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const copyChatLibraryFileMutation = (options?: Partial<Options<CopyChatLibraryFileData>>): UseMutationOptions<CopyChatLibraryFileResponse, CopyChatLibraryFileError, Options<CopyChatLibraryFileData>> => {
    const mutationOptions: UseMutationOptions<CopyChatLibraryFileResponse, CopyChatLibraryFileError, Options<CopyChatLibraryFileData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const emptyChatLibraryTrashMutation = (options?: Partial<Options<EmptyChatLibraryTrashData>>): UseMutationOptions<EmptyChatLibraryTrashResponse, EmptyChatLibraryTrashError, Options<EmptyChatLibraryTrashData>> => {
    const mutationOptions: UseMutationOptions<EmptyChatLibraryTrashResponse, EmptyChatLibraryTrashError, Options<EmptyChatLibraryTrashData>> = {
        mutationFn: async (fnOptions) => {
...
export const listChatLibraryArchivesQueryKey = (options?: Options<ListChatLibraryArchivesData>) => createQueryKey('listChatLibraryArchives', options);

/**
 * The caller's own archives that have not expired
 */
export const listChatLibraryArchivesOptions = (options?: Options<ListChatLibraryArchivesData>) => queryOptions<ListChatLibraryArchivesResponse, ListChatLibraryArchivesError, ListChatLibraryArchivesResponse, ReturnType<typeof listChatLibraryArchivesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listChatLibraryArchives({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listChatLibraryArchivesQueryKey(options)
});

/**
 * Ask for a ZIP of the selected files; a worker packs it and its owner downloads it until it expires
 */
export const requestChatLibraryArchiveMutation = (options?: Partial<Options<RequestChatLibraryArchiveData>>): UseMutationOptions<RequestChatLibraryArchiveResponse, RequestChatLibraryArchiveError, Options<RequestChatLibraryArchiveData>> => {
    const mutationOptions: UseMutationOptions<RequestChatLibraryArchiveResponse, RequestChatLibraryArchiveError, Options<RequestChatLibraryArchiveData>> = {
        mutationFn: async (fnOptions) => {
...
export const listChatExportsQueryKey = (options?: Options<ListChatExportsData>) => createQueryKey('listChatExports', options);

/**
 * The caller's exports that are still worth offering
 */
export const listChatExportsOptions = (options?: Options<ListChatExportsData>) => queryOptions<ListChatExportsResponse, ListChatExportsError, ListChatExportsResponse, ReturnType<typeof listChatExportsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listChatExports({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listChatExportsQueryKey(options)
});

/**
 * Ask for a ZIP of the caller's own conversations and files
 */
export const requestChatExportMutation = (options?: Partial<Options<RequestChatExportData>>): UseMutationOptions<RequestChatExportResponse, RequestChatExportError, Options<RequestChatExportData>> => {
    const mutationOptions: UseMutationOptions<RequestChatExportResponse, RequestChatExportError, Options<RequestChatExportData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await requestChatExport({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listDocumentSetsQueryKey = (options?: Options<ListDocumentSetsData>) => createQueryKey('listDocumentSets', options);

/**
 * List Document Sets the actor can use
 */
export const listDocumentSetsOptions = (options?: Options<ListDocumentSetsData>) => queryOptions<ListDocumentSetsResponse, ListDocumentSetsError, ListDocumentSetsResponse, ReturnType<typeof listDocumentSetsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listDocumentSetsQueryKey(options)
});

export const listDocumentSetsInfiniteQueryKey = (options?: Options<ListDocumentSetsData>): QueryKey<Options<ListDocumentSetsData>> => createQueryKey('listDocumentSets', options, true);

/**
 * List Document Sets the actor can use
 */
export const listDocumentSetsInfiniteOptions = (options?: Options<ListDocumentSetsData>) => {
    const opts = infiniteQueryOptions<ListDocumentSetsResponse, ListDocumentSetsError, InfiniteData<ListDocumentSetsResponse>, QueryKey<Options<ListDocumentSetsData>>, number | Pick<QueryKey<Options<ListDocumentSetsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListDocumentSetsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: listDocumentSetsInfiniteQueryKey(options)
    });
    return opts as Omit<typeof opts, 'initialData'>;
};
 ...
 */
export const createDocumentSetMutation = (options?: Partial<Options<CreateDocumentSetData>>): UseMutationOptions<CreateDocumentSetResponse, CreateDocumentSetError, Options<CreateDocumentSetData>> => {
    const mutationOptions: UseMutationOptions<CreateDocumentSetResponse, CreateDocumentSetError, Options<CreateDocumentSetData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createDocumentSet({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listUsageReportsQueryKey = (options?: Options<ListUsageReportsData>) => createQueryKey('listUsageReports', options);

/**
 * The Tenant's usage reports, newest first; requires model management
 */
export const listUsageReportsOptions = (options?: Options<ListUsageReportsData>) => queryOptions<ListUsageReportsResponse, ListUsageReportsError, ListUsageReportsResponse, ReturnType<typeof listUsageReportsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listUsageReportsQueryKey(options)
});

/**
 * Queue a usage report for a UTC day range; requires model management
 */
export const requestUsageReportMutation = (options?: Partial<Options<RequestUsageReportData>>): UseMutationOptions<RequestUsageReportResponse, RequestUsageReportError, Options<RequestUsageReportData>> => {
    const mutationOptions: UseMutationOptions<RequestUsageReportResponse, RequestUsageReportError, Options<RequestUsageReportData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await requestUsageReport({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listAiUsageLimitsQueryKey = (options?: Options<ListAiUsageLimitsData>) => createQueryKey('listAiUsageLimits', options);

/**
 * The Tenant's AI spending limits; requires model management
 */
export const listAiUsageLimitsOptions = (options?: Options<ListAiUsageLimitsData>) => queryOptions<ListAiUsageLimitsResponse, ListAiUsageLimitsError, ListAiUsageLimitsResponse, ReturnType<typeof listAiUsageLimitsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listAiUsageLimits({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listAiUsageLimitsQueryKey(options)
});

/**
 * Sets a spending limit for the Tenant, a Group or each person; requires model management
 */
export const createAiUsageLimitMutation = (options?: Partial<Options<CreateAiUsageLimitData>>): UseMutationOptions<CreateAiUsageLimitResponse, CreateAiUsageLimitError, Options<CreateAiUsageLimitData>> => {
    const mutationOptions: UseMutationOptions<CreateAiUsageLimitResponse, CreateAiUsageLimitError, Options<CreateAiUsageLimitData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createAiUsageLimit({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const changeChatLibraryFileMutation = (options?: Partial<Options<ChangeChatLibraryFileData>>): UseMutationOptions<ChangeChatLibraryFileResponse, ChangeChatLibraryFileError, Options<ChangeChatLibraryFileData>> => {
    const mutationOptions: UseMutationOptions<ChangeChatLibraryFileResponse, ChangeChatLibraryFileError, Options<ChangeChatLibraryFileData>> = {
        mutationFn: async (fnOptions) => {
...
export const getSearchSettingsQueryKey = (options?: Options<GetSearchSettingsData>) => createQueryKey('getSearchSettings', options);

/**
 * Read the present, future and retained past search generations with rebuild progress
 */
export const getSearchSettingsOptions = (options?: Options<GetSearchSettingsData>) => queryOptions<GetSearchSettingsResponse, GetSearchSettingsError, GetSearchSettingsResponse, ReturnType<typeof getSearchSettingsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const listEmbeddingModelPresetsOptions = (options?: Options<ListEmbeddingModelPresetsData>) => queryOptions<ListEmbeddingModelPresetsResponse, ListEmbeddingModelPresetsError, ListEmbeddingModelPresetsResponse, ReturnType<typeof listEmbeddingModelPresetsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listEmbeddingModelPresets({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listEmbeddingModelPresetsQueryKey(options)
});
...
export const readSearchDocumentSpreadsheetQueryKey = (options: Options<ReadSearchDocumentSpreadsheetData>) => createQueryKey('readSearchDocumentSpreadsheet', options);

/**
 * Read the workbook original of a search result as CSV text per sheet
 */
export const readSearchDocumentSpreadsheetOptions = (options: Options<ReadSearchDocumentSpreadsheetData>) => queryOptions<ReadSearchDocumentSpreadsheetResponse, DefaultError, ReadSearchDocumentSpreadsheetResponse, ReturnType<typeof readSearchDocumentSpreadsheetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await readSearchDocumentSpreadsheet({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: readSearchDocumentSpreadsheetQueryKey(options)
});
...
export const exportMeetingTranscriptQueryKey = (options: Options<ExportMeetingTranscriptData>) => createQueryKey('exportMeetingTranscript', options);

/**
 * Download what was said, with its times and speakers, as Word or PDF
 */
export const exportMeetingTranscriptOptions = (options: Options<ExportMeetingTranscriptData>) => queryOptions<ExportMeetingTranscriptResponse, ExportMeetingTranscriptError, ExportMeetingTranscriptResponse, ReturnType<typeof exportMeetingTranscriptQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: exportMeetingTranscriptQueryKey(options)
});

export const listMeetingTranscribersQueryKey = (options?: Options<ListMeetingTranscribersData>) => createQueryKey('listMeetingTranscribers', options);

/**
 * The speech connections a recording may be transcribed with, the Tenant's own first
 */
export const listMeetingTranscribersOptions = (options?: Options<ListMeetingTranscribersData>) => queryOptions<ListMeetingTranscribersResponse, ListMeetingTranscribersError, ListMeetingTranscribersResponse, ReturnType<typeof listMeetingTranscribersQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listMeetingTranscribers({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listMeetingTranscribersQueryKey(options)
});
...
export const searchPrincipalsQueryKey = (options?: Options<SearchPrincipalsData>) => createQueryKey('searchPrincipals', options);
...
export const searchPrincipalsOptions = (options?: Options<SearchPrincipalsData>) => queryOptions<SearchPrincipalsResponse, SearchPrincipalsError, SearchPrincipalsResponse, ReturnType<typeof searchPrincipalsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await searchPrincipals({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: searchPrincipalsQueryKey(options)
});
...
export const previewChatRetentionQueryKey = (options?: Options<PreviewChatRetentionData>) => createQueryKey('previewChatRetention', options);

/**
 * How many of your conversations a retention policy would delete now
 */
export const previewChatRetentionOptions = (options?: Options<PreviewChatRetentionData>) => queryOptions<PreviewChatRetentionResponse, PreviewChatRetentionError, PreviewChatRetentionResponse, ReturnType<typeof previewChatRetentionQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await previewChatRetention({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: previewChatRetentionQueryKey(options)
});
...
export const getChatLibraryUsageQueryKey = (options?: Options<GetChatLibraryUsageData>) => createQueryKey('getChatLibraryUsage', options);

/**
 * What the caller's file library holds and the storage limit that applies to them
 */
export const getChatLibraryUsageOptions = (options?: Options<GetChatLibraryUsageData>) => queryOptions<GetChatLibraryUsageResponse, GetChatLibraryUsageError, GetChatLibraryUsageResponse, ReturnType<typeof getChatLibraryUsageQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatLibraryUsage({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatLibraryUsageQueryKey(options)
});

export const getChatLibraryTrashWindowQueryKey = (options?: Options<GetChatLibraryTrashWindowData>) => createQueryKey('getChatLibraryTrashWindow', options);

/**
 * How long a deleted file stays in the trash in this deployment
 */
export const getChatLibraryTrashWindowOptions = (options?: Options<GetChatLibraryTrashWindowData>) => queryOptions<GetChatLibraryTrashWindowResponse, GetChatLibraryTrashWindowError, GetChatLibraryTrashWindowResponse, ReturnType<typeof getChatLibraryTrashWindowQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatLibraryTrashWindow({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatLibraryTrashWindowQueryKey(options)
});

export const searchChatLibraryContentQueryKey = (options: Options<SearchChatLibraryContentData>) => createQueryKey('searchChatLibraryContent', options);

/**
 * Find the caller's own indexed uploads by what they contain, with the matching passages
 */
export const searchChatLibraryContentOptions = (options: Options<SearchChatLibraryContentData>) => queryOptions<SearchChatLibraryContentResponse, SearchChatLibraryContentError, SearchChatLibraryContentResponse, ReturnType<typeof searchChatLibraryContentQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await searchChatLibraryContent({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: searchChatLibraryContentQueryKey(options)
});

export const getChatLibraryArchiveQueryKey = (options: Options<GetChatLibraryArchiveData>) => createQueryKey('getChatLibraryArchive', options);

/**
 * One archive of the caller, with its status
 */
export const getChatLibraryArchiveOptions = (options: Options<GetChatLibraryArchiveData>) => queryOptions<GetChatLibraryArchiveResponse, GetChatLibraryArchiveError, GetChatLibraryArchiveResponse, ReturnType<typeof getChatLibraryArchiveQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatLibraryArchive({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatLibraryArchiveQueryKey(options)
});

export const downloadChatLibraryArchiveQueryKey = (options: Options<DownloadChatLibraryArchiveData>) => createQueryKey('downloadChatLibraryArchive', options);

/**
 * Download the caller's own archive while it lives
 */
export const downloadChatLibraryArchiveOptions = (options: Options<DownloadChatLibraryArchiveData>) => queryOptions<DownloadChatLibraryArchiveResponse, DownloadChatLibraryArchiveError, DownloadChatLibraryArchiveResponse, ReturnType<typeof downloadChatLibraryArchiveQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await downloadChatLibraryArchive({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: downloadChatLibraryArchiveQueryKey(options)
});
...
export const listChatHistoryQueryKey = (options?: Options<ListChatHistoryData>) => createQueryKey('listChatHistory', options);

/**
 * The Tenant's conversations, newest first; requires conversation history access
 */
export const listChatHistoryOptions = (options?: Options<ListChatHistoryData>) => queryOptions<ListChatHistoryResponse, ListChatHistoryError, ListChatHistoryResponse, ReturnType<typeof listChatHistoryQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listChatHistoryQueryKey(options)
});

export const listChatHistoryInfiniteQueryKey = (options?: Options<ListChatHistoryData>): QueryKey<Options<ListChatHistoryData>> => createQueryKey('listChatHistory', options, true);

/**
 * The Tenant's conversations, newest first; requires conversation history access
 */
export const listChatHistoryInfiniteOptions = (options?: Options<ListChatHistoryData>) => {
    const opts = infiniteQueryOptions<ListChatHistoryResponse, ListChatHistoryError, InfiniteData<ListChatHistoryResponse>, QueryKey<Options<ListChatHistoryData>>, string | Pick<QueryKey<Options<ListChatHistoryData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListChatHistoryData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    cursor: pageParam
                }
            };
        ...
        queryKey: listChatHistoryInfiniteQueryKey(options)
    });
    return opts as Omit<typeof opts, 'initialData'>;
};

export const getChatHistoryTranscriptQueryKey = (options: Options<GetChatHistoryTranscriptData>) => createQueryKey('getChatHistoryTranscript', options);

/**
 * One conversation's transcript; the read is itself recorded in the audit log
 */
export const getChatHistoryTranscriptOptions = (options: Options<GetChatHistoryTranscriptData>) => queryOptions<GetChatHistoryTranscriptResponse, GetChatHistoryTranscriptError, GetChatHistoryTranscriptResponse, ReturnType<typeof getChatHistoryTranscriptQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatHistoryTranscript({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatHistoryTranscriptQueryKey(options)
});

export const exportChatHistoryQueryKey = (options?: Options<ExportChatHistoryData>) => createQueryKey('exportChatHistory', options);

/**
 * The conversations the filters select as CSV, at most 50,000 rows; the export is itself recorded
 */
export const exportChatHistoryOptions = (options?: Options<ExportChatHistoryData>) => queryOptions<ExportChatHistoryResponse, ExportChatHistoryError, ExportChatHistoryResponse, ReturnType<typeof exportChatHistoryQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await exportChatHistory({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: exportChatHistoryQueryKey(options)
});
...
export const getChatFileThumbnailQueryKey = (options: Options<GetChatFileThumbnailData>) => createQueryKey('getChatFileThumbnail', options);

/**
 * Read the file library's small rendering of an owner-private uploaded image
 */
export const getChatFileThumbnailOptions = (options: Options<GetChatFileThumbnailData>) => queryOptions<GetChatFileThumbnailResponse, GetChatFileThumbnailError, GetChatFileThumbnailResponse, ReturnType<typeof getChatFileThumbnailQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatFileThumbnail({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatFileThumbnailQueryKey(options)
});
...
export const getChatExportQueryKey = (options: Options<GetChatExportData>) => createQueryKey('getChatExport', options);

/**
 * How far one export has got
 */
export const getChatExportOptions = (options: Options<GetChatExportData>) => queryOptions<GetChatExportResponse, GetChatExportError, GetChatExportResponse, ReturnType<typeof getChatExportQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatExport({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatExportQueryKey(options)
});

export const downloadChatExportQueryKey = (options: Options<DownloadChatExportData>) => createQueryKey('downloadChatExport', options);

/**
 * Download a finished export
 */
export const downloadChatExportOptions = (options: Options<DownloadChatExportData>) => queryOptions<DownloadChatExportResponse, DownloadChatExportError, DownloadChatExportResponse, ReturnType<typeof downloadChatExportQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await downloadChatExport({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: downloadChatExportQueryKey(options)
});
...
export const readChatDocumentSpreadsheetQueryKey = (options: Options<ReadChatDocumentSpreadsheetData>) => createQueryKey('readChatDocumentSpreadsheet', options);

/**
 * Read the workbook original of a cited document as CSV text per sheet
 */
export const readChatDocumentSpreadsheetOptions = (options: Options<ReadChatDocumentSpreadsheetData>) => queryOptions<ReadChatDocumentSpreadsheetResponse, ReadChatDocumentSpreadsheetError, ReadChatDocumentSpreadsheetResponse, ReturnType<typeof readChatDocumentSpreadsheetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await readChatDocumentSpreadsheet({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: readChatDocumentSpreadsheetQueryKey(options)
});
...
export const listAuditEventsInfiniteOptions = (options?: Options<ListAuditEventsData>) => {
    const opts = infiniteQueryOptions<ListAuditEventsResponse, ListAuditEventsError, InfiniteData<ListAuditEventsResponse>, QueryKey<Options<ListAuditEventsData>>, string | Pick<QueryKey<Options<ListAuditEventsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const getAuditEventQueryKey = (options: Options<GetAuditEventData>) => createQueryKey('getAuditEvent', options);

/**
 * One audit event; requires AUDIT_READ
 */
export const getAuditEventOptions = (options: Options<GetAuditEventData>) => queryOptions<GetAuditEventResponse, GetAuditEventError, GetAuditEventResponse, ReturnType<typeof getAuditEventQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const getAuditCatalogQueryKey = (options?: Options<GetAuditCatalogData>) => createQueryKey('getAuditCatalog', options);

/**
 * Every action the audit stream can hold, for the viewer's action filter; requires AUDIT_READ
 */
export const getAuditCatalogOptions = (options?: Options<GetAuditCatalogData>) => queryOptions<GetAuditCatalogResponse, GetAuditCatalogError, GetAuditCatalogResponse, ReturnType<typeof getAuditCatalogQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getAuditCatalogQueryKey(options)
});
...
export const downloadUsageReportQueryKey = (options: Options<DownloadUsageReportData>) => createQueryKey('downloadUsageReport', options);

/**
 * Download a ready usage report as a ZIP; requires model management
 */
export const downloadUsageReportOptions = (options: Options<DownloadUsageReportData>) => queryOptions<DownloadUsageReportResponse, DownloadUsageReportError, DownloadUsageReportResponse, ReturnType<typeof downloadUsageReportQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await downloadUsageReport({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: downloadUsageReportQueryKey(options)
});
...
export const getMyAiUsageStandingQueryKey = (options?: Options<GetMyAiUsageStandingData>) => createQueryKey('getMyAiUsageStanding', options);

/**
 * The budget that binds the caller and what they have spent against it; any member
 */
export const getMyAiUsageStandingOptions = (options?: Options<GetMyAiUsageStandingData>) => queryOptions<GetMyAiUsageStandingResponse, GetMyAiUsageStandingError, GetMyAiUsageStandingResponse, ReturnType<typeof getMyAiUsageStandingQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getMyAiUsageStanding({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getMyAiUsageStandingQueryKey(options)
});
 ...
 */
export const dismissMeetingSpeakerSuggestionMutation = (options?: Partial<Options<DismissMeetingSpeakerSuggestionData>>): UseMutationOptions<DismissMeetingSpeakerSuggestionResponse, DismissMeetingSpeakerSuggestionError, Options<DismissMeetingSpeakerSuggestionData>> => {
    const mutationOptions: UseMutationOptions<DismissMeetingSpeakerSuggestionResponse, DismissMeetingSpeakerSuggestionError, Options<DismissMeetingSpeakerSuggestionData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const removeMeetingBookmarkMutation = (options?: Partial<Options<RemoveMeetingBookmarkData>>): UseMutationOptions<RemoveMeetingBookmarkResponse, RemoveMeetingBookmarkError, Options<RemoveMeetingBookmarkData>> => {
    const mutationOptions: UseMutationOptions<RemoveMeetingBookmarkResponse, RemoveMeetingBookmarkError, Options<RemoveMeetingBookmarkData>> = {
        mutationFn: async (fnOptions) => {
