...
export const getChatStorageQuotaQueryKey = (options?: Options<GetChatStorageQuotaData>) => createQueryKey('getChatStorageQuota', options);

/**
 * Read the Tenant storage limit and its exceptions
 */
export const getChatStorageQuotaOptions = (options?: Options<GetChatStorageQuotaData>) => queryOptions<GetChatStorageQuotaResponse, GetChatStorageQuotaError, GetChatStorageQuotaResponse, ReturnType<typeof getChatStorageQuotaQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getChatStorageQuota({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getChatStorageQuotaQueryKey(options)
});

/**
 * Set or remove the Tenant storage limit per person
 */
export const setChatStorageQuotaMutation = (options?: Partial<Options<SetChatStorageQuotaData>>): UseMutationOptions<SetChatStorageQuotaResponse, SetChatStorageQuotaError, Options<SetChatStorageQuotaData>> => {
    const mutationOptions: UseMutationOptions<SetChatStorageQuotaResponse, SetChatStorageQuotaError, Options<SetChatStorageQuotaData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setChatStorageQuota({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Set or remove one person's own storage limit
 */
export const setChatStoragePersonQuotaMutation = (options?: Partial<Options<SetChatStoragePersonQuotaData>>): UseMutationOptions<SetChatStoragePersonQuotaResponse, SetChatStoragePersonQuotaError, Options<SetChatStoragePersonQuotaData>> => {
    const mutationOptions: UseMutationOptions<SetChatStoragePersonQuotaResponse, SetChatStoragePersonQuotaError, Options<SetChatStoragePersonQuotaData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setChatStoragePersonQuota({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Bound how long this Tenant keeps conversations nobody has touched (Onyx maximum_chat_retention_days)
 */
...
/**
 * How many conversations a retention policy would delete now
 */
