 ...
 */
export const previewChatFileArtifactSpreadsheetOptions = (options: Options<PreviewChatFileArtifactSpreadsheetData>) => queryOptions<unknown, PreviewChatFileArtifactSpreadsheetError, unknown, ReturnType<typeof previewChatFileArtifactSpreadsheetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
