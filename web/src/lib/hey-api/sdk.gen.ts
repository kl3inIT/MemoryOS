 ...
 */
export const unarchiveChatSession = <ThrowOnError extends boolean = false>(options: Options<UnarchiveChatSessionData, ThrowOnError>): RequestResult<UnarchiveChatSessionResponses, UnarchiveChatSessionErrors, ThrowOnError> => (options.client ?? client).delete<UnarchiveChatSessionResponses, UnarchiveChatSessionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'SESSION',
            type: 'apiKey'
 ...
 */
export const archiveChatSession = <ThrowOnError extends boolean = false>(options: Options<ArchiveChatSessionData, ThrowOnError>): RequestResult<ArchiveChatSessionResponses, ArchiveChatSessionErrors, ThrowOnError> => (options.client ?? client).put<ArchiveChatSessionResponses, ArchiveChatSessionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'SESSION',
            type: 'apiKey'
