 ...
 */
export const previewChatFileArtifactSpreadsheet = <ThrowOnError extends boolean = false>(options: Options<PreviewChatFileArtifactSpreadsheetData, ThrowOnError>): RequestResult<unknown, PreviewChatFileArtifactSpreadsheetErrors, ThrowOnError> => (options.client ?? client).get<unknown, PreviewChatFileArtifactSpreadsheetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'SESSION',
            type: 'apiKey'
