 ...
 */
export const testChatProvider = <ThrowOnError extends boolean = false>(options: Options<TestChatProviderData, ThrowOnError>): RequestResult<unknown, TestChatProviderErrors, ThrowOnError> => (options.client ?? client).post<unknown, TestChatProviderErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'SESSION',
            type: 'apiKey'
