 ...
 */
export const readSearchDocumentOriginal = <ThrowOnError extends boolean = false>(options: Options<ReadSearchDocumentOriginalData, ThrowOnError>): RequestResult<ReadSearchDocumentOriginalResponses, unknown, ThrowOnError> => (options.client ?? client).get<ReadSearchDocumentOriginalResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'SESSION',
            type: 'apiKey'
