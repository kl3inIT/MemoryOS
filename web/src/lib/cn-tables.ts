...
const edgeStart = PS(U("E05000020042001300002180000100000212000301002004200000212002120000213000022002100920201002000000003020010800000000220103015000200012005210220002000200030102030020010000"))
const labelStart = PS(U(":1111111121111111931154654441131;31566441111111116252349572322333132111122144341111115222611311111192117116163471111111111327451111111112341135535212114411312152455117"))
...
const nodeGroup = U("0200000000009000;0;=0>0@ABDE0GIJ0000000000Q0000000V±00000000±000`0000000e00000000000000m000000000000000z00000000000000000000000000000000000000000000§¨000Ä0000", 1)
...
const vlistGroup = DZ("")
// nodeVlist rebuilt sparse: (anchor deltas, vlist ids)
const nodeVlist = (() => {
    const out = new Int32Array(168).fill(-1)
    const A = DZ("024222426224222442222222224422422242622224428222442226262244222422222224422222222222262242422422242624222422422422442424222")
    const V = DZ("0222222222220222222222222220222222222222222222222IL222222222222222222222222222222222222222222222202222222222222222222222222")
...
const AA = DZ("0000000000000000000000000000000000000262242622006440>8442246426220020642442444228242202824422222228224222222226262422422242624222444224000444242442")
const AG = DZ("Ĭ222222222222222222222222222222222222ű4222222ŤšŤţ4Ţ2ő:2022ńĻ2222Ķ2ĵÆÃ622Ĭĩ242KN242êçÂ¿24222222222242öí222222222ÞÓ2222222202222222242242¨_b£22222242")
const AS = DZ("02222222222222222222222222222222222222222202222229<22=@214222I10N2222E00H202Y000\\[^_b222232450000082c400000000=pqt000000a21A0@000f2g0?z222}2220uxw")
const litAnchor = new Int32Array(647)
const litGroup = new Int32Array(647)
const litPool = new Int32Array(647)
let poolText = ''
const poolOffsets = new Int32Array(740)
{
...
const adjGid = DZ("0J2>62J8>2284F2>>2>2226:426:V6D2N")
const adjStart = PS(U("1::24432:442:44:44>2222:442122113"))
const adjTgt = DZ("2^297Ƙ2ƍ574ƚ22222Ɨƚ2ƥƐ2ƍ763Ɩ2ƍ=;|¨¯2<2Ĭ22ŏÒm¥hĪŏmĦ2«ãü8¯25Ę22ę3764Ęę1Ğ2ę;\\255ü2õ3544541ú2õ9Ċ2ã53261ê2222212563232Nûþ222ąĈ2272ąĊ4222éÇ:Ð22B0r22")
const patGid = U("¡")
const patTgt = U("e")
