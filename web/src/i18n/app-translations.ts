...
export const vietnameseUi: Record<string, string> = {
  ...
  "Bắt đầu hội thoại": "Start conversation",
  "Chỉnh sửa": "Edit",
  ...
  "Mỗi dòng một câu. Tối đa 8 câu, mỗi câu 1.000 ký tự.":
    "One per line. Up to 8 starters, each at most 1,000 characters.",
  ...
  "Đang tải nguồn…": "Loading sources…",
  ...
  "Để trống để dùng giới hạn của model.": "Leave empty to use the model limits.",
  ...
  Ẩn: "Hidden",
  "Ẩn /{{v1}}": "Hide /{{v1}}",
  "Bạn chưa có lệnh tắt nào.": "You have no shortcuts yet.",
  "Bạn có thể tạo lại sau.": "You can create it again later.",
  ...
  "Chủ sở hữu: {{v1}}": "Owner: {{v1}}",
  "Chưa có chủ sở hữu": "No owner",
  "Chưa có lệnh tắt dùng chung.": "No shared shortcuts yet.",
  ...
  "Đang dùng ảnh đại diện đã tải lên.": "Using the uploaded avatar image.",
  ...
  "Gõ / ở đầu ô chat để chèn nhanh một câu hỏi đã lưu.":
    "Type / at the start of the composer to insert a saved question.",
  "Gỡ {{v1}}": "Remove {{v1}}",
  "Hiện /{{v1}}": "Show /{{v1}}",
  "Hiển thị": "Listing",
  "Hiển thị {{v1}}": "Listing for {{v1}}",
  "Hiển thị trong thư viện": "Show in the gallery",
  ...
  "Khôi phục": "Restore",
  "Không chọn nguồn: tìm trong tất cả nguồn người dùng được phép đọc.":
    "No sources selected: search every source the user can read.",
  ...
  "Lệnh tắt câu hỏi": "Prompt shortcuts",
  "Lệnh tắt dùng chung": "Shared shortcuts",
  "Lệnh tắt sẽ biến mất với mọi thành viên.": "The shortcut will disappear for every member.",
  ...
  "Mọi người trong tổ chức có thể dùng": "Everyone in the organization can use",
  ...
  "Người dùng trợ lý chỉ nhận câu trả lời từ tài liệu họ được phép đọc. Hướng dẫn của trợ lý được ưu tiên hơn hướng dẫn dự án.":
    "Agent users only get answers from documents they can read. Agent instructions take precedence over project instructions.",
  ...
  "Nhãn mới, ví dụ: Tài chính": "New label, for example: Finance",
  ...
  "Nổi bật": "Featured",
  "Nội dung": "Content",
  "Quản lý lệnh tắt": "Manage shortcuts",
  ...
  "Số nhỏ hiện trước. Bỏ trống để xếp theo tên.":
    "Lower numbers appear first. Leave empty to sort by name.",
  "Sửa /{{v1}}": "Edit /{{v1}}",
  "Sửa lệnh tắt": "Edit shortcut",
  ...
  "Tên dùng sau dấu /, không có khoảng trắng. Nội dung thay cho câu hỏi đang soạn.":
    "The name follows /, without spaces. The content replaces the question being written.",
  "Tên không được chứa khoảng trắng.": "The name cannot contain spaces.",
  ...
  "Tìm người hoặc Group": "Search people or Groups",
  ...
  "Trợ lý nổi bật, công khai và đang hiển thị được ghim sẵn cho người dùng mới. Trợ lý bị ẩn vẫn mở được bằng liên kết.":
    "Featured, public, listed agents are pinned for new users. Unlisted agents still open from a link.",
...
Object.assign(vietnameseUi, {
  ...
  "Dùng tối đa 8 câu hỏi gợi ý.": "Use at most 8 starter questions.",
  "Mỗi câu hỏi gợi ý dài tối đa 1.000 ký tự.":
    "Each starter question can contain at most 1,000 characters.",
