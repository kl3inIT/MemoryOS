...
export const vietnameseUi: Record<string, string> = {
  ...
  "Ngữ cảnh (token)": "Context (tokens)",
  "Câu trả lời (token)": "Answer (tokens)",
...
export const englishUi: Record<string, string> = {
  ...
  Content: "Nội dung",
  "Google Drive permissions": "Quyền từ Google Drive",
  ...
  "Inspect the permissions collected from Google Drive. These observations do not determine who can search or chat with a document in MemoryOS.":
    "Xem quyền đã thu thập từ Google Drive. Dữ liệu này không quyết định ai được tìm kiếm hoặc trò chuyện với tài liệu trong MemoryOS.",
  "Find a file or folder": "Tìm tệp hoặc thư mục",
  "Name or Google file ID": "Tên hoặc ID tệp Google",
  "Loading permission observations…": "Đang tải dữ liệu quyền…",
  "{{count}} tracked files and folders": "{{count}} tệp và thư mục được theo dõi",
  "Permission observations": "Dữ liệu quyền đã thu thập",
  "File or folder": "Tệp hoặc thư mục",
  "Permission entries": "Mục quyền",
  "Last successful observation": "Thu thập thành công gần nhất",
  "View permissions": "Xem quyền",
  "No files match this search.": "Không có tệp phù hợp với tìm kiếm này.",
  "No tracked files yet. Synchronize the Source to collect file and permission observations.":
    "Chưa có tệp được theo dõi. Đồng bộ nguồn để thu thập thông tin tệp và quyền.",
  "Permission observation pages": "Các trang dữ liệu quyền",
  "Permission observations per page": "Số dòng dữ liệu quyền mỗi trang",
  "Close permission details": "Đóng chi tiết quyền",
  "{{count}} permission entries": "{{count}} mục quyền",
  "Permission entries unknown": "Chưa rõ số mục quyền",
  "Last observed": "Quan sát gần nhất",
  Stale: "Đã cũ",
  Observed: "Đã quan sát",
  "Permission details for {{v1}}": "Chi tiết quyền của {{v1}}",
  "No expiry": "Không hết hạn",
  "Observed permissions": "Quyền đã thu thập",
  "Permission snapshot": "Ảnh chụp quyền",
  "Collected Google permissions for this file. Refresh re-reads the latest MemoryOS observation.":
    "Quyền Google đã thu thập cho tệp này. Làm mới sẽ đọc lại lần quan sát mới nhất trong MemoryOS.",
  "No permission observation has been recorded for this file yet.":
    "Chưa ghi nhận dữ liệu quyền của tệp này.",
  "Last refresh failed. The permissions below are from the last successful observation.":
    "Lần cập nhật gần nhất thất bại. Quyền bên dưới thuộc lần thu thập thành công trước đó.",
  "No successful permission snapshot yet.": "Chưa có lần thu thập quyền thành công.",
  "The Source context has changed. Treat this snapshot as historical evidence, not current access.":
    "Trạng thái nguồn đã thay đổi. Đây là dữ liệu lịch sử, không phải quyền truy cập hiện tại.",
  "Google returned an empty permission list. This does not mean the file is public.":
    "Google trả về danh sách quyền trống. Điều này không có nghĩa tệp là công khai.",
  "Permission entry pages": "Các trang mục quyền",
  "Observation provenance": "Nguồn gốc lần quan sát",
  "Google file ID": "ID tệp Google",
  "Source operation": "Tác vụ nguồn",
  "Read at": "Thời điểm đọc dữ liệu",
  User: "Người dùng",
  Domain: "Tên miền",
  Anyone: "Bất kỳ ai",
  Organizer: "Người quản lý",
  "File organizer": "Người tổ chức tệp",
  Editor: "Người chỉnh sửa",
  Commenter: "Người nhận xét",
  Viewer: "Người xem",
  Expiration: "Hết hạn",
  "Not returned by Google": "Google không cung cấp",
  Discovery: "Khả năng tìm thấy",
  Discoverable: "Có thể tìm thấy",
  "Link only": "Qua liên kết",
  "Google marks this account as deleted.": "Google đánh dấu tài khoản này đã bị xóa.",
  "Ownership transfer pending": "Đang chờ chuyển quyền sở hữu",
  "Inheritance and provider details": "Kế thừa và chi tiết từ Google",
  "Permission ID": "ID quyền",
  "Permission view": "Phạm vi hiển thị quyền",
  "Inherited permissions disabled": "Đã tắt quyền kế thừa",
  Yes: "Có",
  No: "Không",
  "Inheritance not returned": "Không có thông tin kế thừa",
  Inherited: "Kế thừa",
  Direct: "Trực tiếp",
  "No inheritance details returned. This does not prove the permission is direct.":
    "Không nhận được chi tiết kế thừa. Chưa thể kết luận đây là quyền trực tiếp.",
  "Context matches": "Trạng thái khớp",
  "Stale context": "Trạng thái đã thay đổi",
  "Inactive context": "Trạng thái không còn hợp lệ",
  "Not observed": "Chưa quan sát",
  "Refresh failed": "Cập nhật thất bại",
  "Snapshot collected": "Đã thu thập",
