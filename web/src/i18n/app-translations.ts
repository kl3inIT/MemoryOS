...
export const vietnameseUi: Record<string, string> = {
  "Không hoàn tất: {{count}}": "Not completed: {{count}}",
  "Đang suy luận…": "Reasoning…",
  "Suy luận": "Reasoning",
  "Đã suy luận": "Reasoned",
  ...
  "Tìm kiếm: {{count}}": "Searches: {{count}}",
  "Nguồn đã đọc: {{count}}": "Sources read: {{count}}",
  "Thẻ trình bày: {{count}}": "Visual cards: {{count}}",
  "Công cụ: {{count}}": "Tools: {{count}}",
