...
Object.assign(englishUi, {
  ...
  "Deletion failed. Refresh before retrying.":
    "Xóa thất bại. Làm mới trước khi thử lại.",
  ...
  "Overrides the Tenant default for this Persona.":
    "Ghi đè mặc định của Tenant cho Persona này.",
