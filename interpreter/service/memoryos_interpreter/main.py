...
SERVICE_VERSION: Final[str] = _package_version("memoryos-interpreter")
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="MemoryOS Interpreter API",
...
def run() -> None:
    ...
    uvicorn.run("memoryos_interpreter.main:app", host=HOST, port=PORT, log_config=None)
