...
PYTHON_EXECUTOR_DOCKER_IMAGE = (
    os.environ.get("PYTHON_EXECUTOR_DOCKER_IMAGE")
    or "ghcr.io/kl3init/memoryos-interpreter-executor"
)
...
# for maximum isolation. Set to a Docker network name (e.g. "memoryos-internal")
...
KUBERNETES_EXECUTOR_IMAGE = (
    os.environ.get("KUBERNETES_EXECUTOR_IMAGE") or "ghcr.io/kl3init/memoryos-interpreter-executor"
)
...
FILE_STORAGE_DIR = (
    os.environ.get("FILE_STORAGE_DIR") or "/tmp/memoryos-interpreter-files"  # noqa: S108
)
