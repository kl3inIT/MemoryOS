...
class SearchController {
    ...
    @Operation(operationId = "readSearchDocumentOriginal", summary = "Read the original file of a search result to show it as stored")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Original file bytes",
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "206", description = "Requested byte range of the original file",
            content = @io.swagger.v3.oas.annotations.media.Content(mediaType = org.springframework.http.MediaType.APPLICATION_OCTET_STREAM_VALUE,
                    schema = @io.swagger.v3.oas.annotations.media.Schema(type = "string", format = "binary")))
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "416", description = "Requested byte range starts beyond the original file")
