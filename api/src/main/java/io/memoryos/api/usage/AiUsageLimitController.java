...
@Tag(name = "AI costs")
@ApiResponse(responseCode = "400", description = "Invalid budget or period")
@ApiResponse(responseCode = "403", description = "Model management requirement not met")
...
class AiUsageLimitController {
    ...
    List<AiUsageLimitResponse> list(@CurrentActor IdentityContext identity) {
    ...
    AiUsageLimitResponse update(@CurrentActor IdentityContext identity,
