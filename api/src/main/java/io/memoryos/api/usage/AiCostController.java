...
@Tag(name = "AI costs")
@ApiResponse(responseCode = "400", description = "Invalid period or filter")
@ApiResponse(responseCode = "403", description = "Model management or Tenant membership requirement not met")
...
class AiCostController {
    ...
    AiCostSummaryResponse summary(@CurrentActor IdentityContext identity,
    ...
    List<AiCostDayResponse> daily(@CurrentActor IdentityContext identity,
                    @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
                    @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to,
    ...
    List<AiCostRowResponse> breakdown(@CurrentActor IdentityContext identity,
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to,
    ...
    AiCostDetailResponse mine(@CurrentActor IdentityContext identity,
                @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
                @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to) {
    ...
    AiCostDetailResponse detail(@CurrentActor IdentityContext identity,
                  @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
                  @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to,
