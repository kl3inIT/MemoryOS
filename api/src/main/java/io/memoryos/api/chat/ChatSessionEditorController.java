...
class ChatSessionEditorController {
    ...
    ChatSessionResponse rename(@CurrentActor IdentityContext identity,
    ...
    void delete(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId) {
    ...
    ChatSessionResponse generateTitle(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId) {
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    List<ChatBranch> branches(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId) {
    ...
    void branch(@CurrentActor IdentityContext identity,
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    ChatSessionResponse persona(@CurrentActor IdentityContext identity,
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    ChatSessionResponse project(@CurrentActor IdentityContext identity,
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    ChatSessionResponse reasoning(@CurrentActor IdentityContext identity,
    ...
    ChatSessionResponse configure(@CurrentActor IdentityContext identity,
