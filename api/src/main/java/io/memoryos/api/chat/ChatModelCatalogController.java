...
@ApiResponse(responseCode = "409", description = "Stale revision or duplicate model")
@ApiResponse(responseCode = "503", description = "Provider, encryption key or client capacity unavailable")
...
class ChatModelCatalogController {
    ...
    List<AvailableChatModelResponse> available(@CurrentActor IdentityContext identity,
    ...
    List<ChatProviderAdapterResponse> adapters(@CurrentActor IdentityContext identity) {
    ...
    List<ChatProviderResponse> providers(@CurrentActor IdentityContext identity) {
    ...
    ChatProviderResponse createProvider(@CurrentActor IdentityContext identity, @RequestBody ChatProviderRequest request) {
    ...
    ChatProviderTestResponse testProvider(@CurrentActor IdentityContext identity,
    ...
    ChatProviderResponse updateProvider(@CurrentActor IdentityContext identity,
    ...
    void deleteProvider(@CurrentActor IdentityContext identity,
    ...
    ChatReportedModelsResponse reportedModels(@CurrentActor IdentityContext identity,
            @RequestBody ChatProviderTestRequest request) {
        var probe = catalog.probeProvider(identity.actorId(), request.providerId(), request.adapterType(), request.baseUrl(),
                request.credential() == null ? null : request.credential().toInput());
    ...
    List<ChatModelResponse> configured(@CurrentActor IdentityContext identity, @PathVariable UUID providerId) {
    ...
    ChatModelResponse createModel(@CurrentActor IdentityContext identity,
    ...
    ChatModelResponse updateModel(@CurrentActor IdentityContext identity,
    ...
    void deleteModel(@CurrentActor IdentityContext identity,
    ...
    ChatModelDefaultResponse defaultModel(@CurrentActor IdentityContext identity) {
    ...
    ChatModelDefaultResponse setDefault(@CurrentActor IdentityContext identity,
    ...
    List<ChatModelFlowResponse> flows(@CurrentActor IdentityContext identity) {
    ...
    ChatPersonaPageResponse personas(@CurrentActor IdentityContext identity,
    ...
    ChatPersonaModelResponse persona(@CurrentActor IdentityContext identity, @PathVariable UUID personaId) {
    ...
    ChatPersonaModelResponse setPersona(@CurrentActor IdentityContext identity,
    ...
    ChatModelValidationResponse validate(@CurrentActor IdentityContext identity, @PathVariable UUID modelId) {
