...
class DocumentSetController {
    ...
    List<View> list(@CurrentActor IdentityContext identity,
    ...
    View get(@CurrentActor IdentityContext identity, @PathVariable UUID documentSetId) {
    ...
    View create(@CurrentActor IdentityContext identity, @RequestBody Input input) {
    ...
    View update(@CurrentActor IdentityContext identity, @PathVariable UUID documentSetId,
    ...
    void delete(@CurrentActor IdentityContext identity, @PathVariable UUID documentSetId,
    ...
    @ApiResponse(responseCode = "200", description = "Updated Document Set", useReturnTypeSchema = true)
    View share(@CurrentActor IdentityContext identity, @PathVariable UUID documentSetId,
