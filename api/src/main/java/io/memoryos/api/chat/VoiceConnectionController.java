...
@ApiResponse(responseCode = "400", description = "Invalid voice configuration")
@ApiResponse(responseCode = "401", description = "Authentication required", content = @Content)
@ApiResponse(responseCode = "403", description = "Management authority or CSRF required")
@ApiResponse(responseCode = "404", description = "Voice connection unavailable")
@ApiResponse(responseCode = "409", description = "Voice connection changed")
@ApiResponse(responseCode = "503", description = "Voice provider unavailable or busy")
class VoiceConnectionController {
    ...
    VoiceAvailabilityResponse availability(@CurrentActor IdentityContext identity) {
    ...
    List<VoiceConnectionResponse> list(@CurrentActor IdentityContext identity) {
    ...
    VoiceConnectionResponse save(@CurrentActor IdentityContext identity,
    ...
    void select(@CurrentActor IdentityContext identity,
    ...
    void test(@CurrentActor IdentityContext identity, @PathVariable VoiceProvider provider) {
