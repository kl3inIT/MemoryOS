...
class ChatCollaborationController {
    ...
    Sharing sharing(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId) {
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    Sharing share(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId, @RequestBody Sharing request) {
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    SharedSession shared(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId) {
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    List<ChatMessageResponse> history(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId,
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    List<Feedback> feedback(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId,
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    Feedback feedback(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId,
    ...
    void remove(@CurrentActor IdentityContext identity, @PathVariable UUID sessionId,
