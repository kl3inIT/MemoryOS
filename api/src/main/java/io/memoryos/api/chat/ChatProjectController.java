...
class ChatProjectController {
    ...
    List<ProjectView> list(@CurrentActor IdentityContext identity,
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    ProjectView get(@CurrentActor IdentityContext identity, @PathVariable UUID projectId) {
    ...
    ProjectView create(@CurrentActor IdentityContext identity, @RequestBody ProjectInput request) {
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    ProjectView update(@CurrentActor IdentityContext identity, @PathVariable UUID projectId,
    ...
    void delete(@CurrentActor IdentityContext identity, @PathVariable UUID projectId, @RequestParam long revision) {
    ...
    @ApiResponse(responseCode = "200", description = "Successful chat operation", useReturnTypeSchema = true)
    List<ChatSessionResponse> conversations(@CurrentActor IdentityContext identity,
    ...
    @ApiResponse(responseCode = "201", description = "Successful chat operation", useReturnTypeSchema = true)
    ChatSessionResponse conversation(@CurrentActor IdentityContext identity,
