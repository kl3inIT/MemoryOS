...
@ApiResponse(responseCode = "400", description = "Invalid OAuth configuration or unusable authorization-server metadata")
@ApiResponse(responseCode = "401", description = "Authentication required", content = @Content)
@ApiResponse(responseCode = "403", description = "MCP management, Tenant membership or CSRF requirement not met")
@ApiResponse(responseCode = "404", description = "MCP server or OAuth client not accessible")
@ApiResponse(responseCode = "409", description = "Stale revision or duplicate label")
@ApiResponse(responseCode = "503", description = "Authorization server, redirect URI or encryption key unavailable")
class McpOAuthController {
    ...
    McpOAuthDiscoveryResponse discover(@CurrentActor IdentityContext identity,
    ...
    List<McpOAuthClientResponse> clients(@CurrentActor IdentityContext identity,
                                         @PathVariable UUID serverId) {
    ...
    McpOAuthClientResponse createClient(@CurrentActor IdentityContext identity,
    ...
    McpOAuthClientResponse register(@CurrentActor IdentityContext identity,
    ...
    McpOAuthClientResponse updateClient(@CurrentActor IdentityContext identity,
    ...
    void deleteClient(@CurrentActor IdentityContext identity,
    ...
    ResponseEntity<McpOAuthAuthorizationResponse> authorize(@CurrentActor IdentityContext identity,
    ...
    void disconnect(@CurrentActor IdentityContext identity, @PathVariable UUID serverId) {
