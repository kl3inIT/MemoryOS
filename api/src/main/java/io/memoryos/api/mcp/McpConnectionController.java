...
@ApiResponse(responseCode = "400", description = "Unusable API key, return address or server configuration")
@ApiResponse(responseCode = "401", description = "Authentication required", content = @Content)
@ApiResponse(responseCode = "403", description = "Chat use, Tenant membership or CSRF requirement not met")
@ApiResponse(responseCode = "404", description = "MCP server not available to this User")
@ApiResponse(responseCode = "409", description = "Server configuration changed, or the credential was rejected")
...
class McpConnectionController {
    ...
    List<McpConnectionResponse> list(@CurrentActor IdentityContext identity) {
    ...
    McpConnectionResponse apiKey(@CurrentActor IdentityContext identity,
