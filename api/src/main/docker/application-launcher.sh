...
if [ -n "${MEMORYOS_INTERPRETER_API_KEY_FILE:-}" ]; then
    test -r "$MEMORYOS_INTERPRETER_API_KEY_FILE"
    MEMORYOS_INTERPRETER_API_KEY=$(cat "$MEMORYOS_INTERPRETER_API_KEY_FILE")
    test -n "$MEMORYOS_INTERPRETER_API_KEY"
    export MEMORYOS_INTERPRETER_API_KEY
fi
