...
The merged layout contains 83 migrations. Published `main` V1–V79 remain unchanged; this integration assigns SharePoint to V80/V81 and Voice to V82/V83. Historical local V37–V42 are V43 Basic seeding, V44 system-grant renaming, V45 derived-only Group read, V46 unified Source management, V47 scoped manager ownership and V48 ordinary-only Source associations. Model-management grants are preserved; standalone read/delete grants are revoked without promotion. Exact current filenames are listed in [Architecture](ARCHITECTURE.md#data-ownership-and-consistency).
